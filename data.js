...
const GameData = (function() {
    ...
    const DIFFICULTIES = [
      { key: 'elementary', label: '小学校の復習', color: 'bg-lime-700', boss: null },
    ...
    const GENRES = [
      // 化学
      { key: 'matter',      subject: 'chemistry', label: '物質のすがた', icon: '🧊', diffs: ['elementary', 'junior', 'mid'] },
      ...
      { key: 'light_sound', subject: 'physics',   label: '光・音',         icon: '🔦', diffs: ['elementary', 'junior', 'mid'] },
      ...
      // 生物（選択式中心）
      { key: 'bio_plant',   subject: 'biology',   label: '植物',           icon: '🌿', diffs: ['elementary', 'junior', 'mid', 'senior'] },
      ...
      // 地学（選択式中心）
      { key: 'earth_land',  subject: 'earth',     label: '大地（火山・地震・地層）', icon: '🌋', diffs: ['elementary', 'junior', 'mid', 'senior'] },
  ...
  { subject: 'chemistry', genre: 'experiment', diff: 'mid', type: 'choice', name: '塩化物イオンの確認',
    ...
    {"subject":"physics","genre":"light_sound","diff":"mid","type":"choice","q":"凸レンズ実像の向きは？","c":["上下左右が逆","同じ向き","上下だけ同じ","左右だけ同じ"],"a":0,"desc":"凸レンズによる実像は、物体に対して上下左右が逆向きにできる。"},
    ...
    {"subject":"physics","genre":"force","diff":"junior","type":"choice","q":"力2倍でばねの伸びは？","c":["変わらない","2倍になる","必ず0になる","半分になる"],"a":1,"desc":"ばねののびは、限度内では加えた力に比例する。これをフックの法則として扱う。"},
    ...
    {"subject":"physics","genre":"electricity","diff":"junior","type":"choice","q":"電流の向きはどれ？","c":["電池のマイナス極からプラス極","導線の外へ逃げる向き","電子と必ず同じ向き","電池のプラス極からマイナス極"],"a":3,"desc":"電流の向きはプラス極からマイナス極へ流れる向きとして扱う。電子の移動向きとは逆になる。"},
    ...
    {"subject":"physics","genre":"electricity","diff":"supreme","type":"choice","q":"電流コイル周りのものは？","c":["真空","二酸化炭素","磁界","凸レンズ"],"a":2,"desc":"電流が流れる導線やコイルのまわりには磁界ができる。電磁石はこの性質を利用する。"},
    ...
    {"subject":"physics","genre":"motion","diff":"mid","type":"choice","q":"等速の距離時間グラフは？","c":["原点を通る直線","水平な直線だけ","ぎざぎざの線だけ","必ず円"],"a":0,"desc":"速さが一定なら、進んだ距離は時間に比例するため、距離-時間グラフは直線になる。"},
    ...
    {"subject":"physics","genre":"motion","diff":"supreme","type":"choice","q":"摩擦なし、位置と運動エネの和は？","c":["合計は保存される","運動エネルギーだけ増え続ける","どちらも常に0になる","位置エネルギーだけ保存される"],"a":0,"desc":"摩擦などで失われない場合、位置エネルギーと運動エネルギーの合計である力学的エネルギーは保存される。"},
    ...
    {"subject":"biology","genre":"bio_human","diff":"mid","type":"choice","q":"中枢神経にあたるものは？","c":["脳とせきずい","骨と関節","赤血球と血小板","皮膚と筋肉"],"a":0,"desc":"中枢神経は脳とせきずいで、刺激の情報を判断し命令を出す中心になる。"},
    ...
    {"subject":"biology","genre":"bio_cell","diff":"mid","type":"choice","q":"体細胞分裂後の染色体数は？","c":["必ず2倍になる","必ず半分になる","同じになる","0になる"],"a":2,"desc":"体細胞分裂では、同じ染色体数をもつ細胞ができ、からだの成長や修復に関わる。"},
    ...
    {"subject":"biology","genre":"bio_cell","diff":"senior","type":"choice","q":"対立形質で現れやすい形質は？","c":["突然変異だけ","顕性形質","潜性形質","無性生殖"],"a":1,"desc":"対立形質のうち、組み合わせによって表れやすい方を顕性形質という。"},
    ...
    {"subject":"earth","genre":"earth_land","diff":"junior","type":"choice","q":"過去の生物や環境を示すものは？","c":["磁力線","化石","太陽黒点","露点"],"a":1,"desc":"化石は生物のからだや生活のあとが残ったもので、地層ができた時代や環境の手がかりになる。"},
    ...
    {"subject":"earth","genre":"earth_land","diff":"mid","type":"choice","q":"下の地層ほどどう判断する？","c":["古い","新しい","同じ日にできた","必ず火山灰である"],"a":0,"desc":"地層が乱されていない場合、下の層ほど先に堆積しており古いと考える。"},
    ...
    {"subject":"earth","genre":"earth_space","diff":"senior","type":"choice","q":"日食の並びは？","c":["太陽-地球-月","地球-太陽-月","太陽-月-地球","月-太陽-地球"],"a":2,"desc":"日食は月が太陽の前を通り、月の影が地球に落ちることで起こる。"},
    {"subject":"earth","genre":"earth_space","diff":"senior","type":"choice","q":"地軸の傾きで起こる現象は？","c":["音の反射","火山灰の堆積","季節の変化","地震の発生"],"a":2,"desc":"地軸が傾いているため、太陽高度や昼の長さが季節で変わり、気温の差が生じる。"},
    ...
    {"subject":"earth","genre":"earth_space","diff":"senior","type":"choice","q":"月食の並びは？","c":["太陽-地球-月","月-太陽-地球","太陽-月-地球","地球-月-太陽"],"a":0,"desc":"月食は地球の影に月が入ることで起こるため、太陽・地球・月の順に並ぶ。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "花弁がくっついた花は？", "c": ["合弁花", "離弁花", "裸子花", "単性花"], "a": 0, "desc": "花弁がくっついている花を合弁花、1枚ずつ離れている花を離弁花という。タンポポ・アサガオは合弁花。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "花弁が1枚ずつ離れた花は？", "c": ["胞子花", "離弁花", "合弁花", "単子葉花"], "a": 1, "desc": "花弁が1枚ずつ離れている花を離弁花という。アブラナ・サクラ・エンドウなどが当てはまる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "葉から水蒸気を出すはたらきは？", "c": ["光合成", "呼吸", "蒸発のみ", "蒸散"], "a": 3, "desc": "根から吸った水を葉の気孔から水蒸気として出すはたらきを蒸散という。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "双子葉類の根のつくりは？", "c": ["根毛だけ", "仮根", "主根と側根", "ひげ根"], "a": 2, "desc": "双子葉類は主根と側根からなる根をもつ。単子葉類はひげ根が多い。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "細い根が多数広がる根は？", "c": ["主根", "側根", "根毛", "ひげ根"], "a": 3, "desc": "単子葉類はひげ根をもつことが多い。双子葉類は主根と側根をもつ。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "マツはどの植物の仲間か？", "c": ["シダ植物", "コケ植物", "裸子植物", "被子植物"], "a": 2, "desc": "マツは裸子植物で、花弁やがくのない花をつくる。胚珠がむき出しになっている。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "光合成に必要な組み合わせは？", "c": ["光・二酸化炭素・水", "酸素・窒素・光", "水・酸素・暗やみ", "デンプン・酸素・光"], "a": 0, "desc": "光合成には光・二酸化炭素・水が必要で、デンプンと酸素ができる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "junior", "type": "choice", "q": "葉が緑に見える理由は？", "c": ["葉緑体", "液胞", "核", "細胞壁"], "a": 0, "desc": "葉緑体には緑色の色素が含まれ、ここで光合成が行われる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "葉を脱色する薬品は？", "c": ["あたためたエタノール", "うすい塩酸", "石灰水", "BTB溶液"], "a": 0, "desc": "葉をあたためたエタノールにひたして脱色すると、ヨウ素液での色の変化が見やすくなる。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "デンプン確認で最後に使う薬品は？", "c": ["うすい硫酸", "ヨウ素液", "石灰水", "フェノールフタレイン液"], "a": 1, "desc": "ヨウ素液はデンプンがあると青紫色に変化する。脱色した葉にかけて調べる。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "二酸化炭素確認に使う薬品は？", "c": ["BTB溶液", "うすい塩酸", "石灰水", "ヨウ素液"], "a": 2, "desc": "石灰水は二酸化炭素を通すと白くにごる。呼吸で出る二酸化炭素の確認に使う。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "BTBが青色、使われた気体は？", "c": ["酸素", "デンプン", "水素", "二酸化炭素"], "a": 3, "desc": "光合成で二酸化炭素が使われると水溶液中の二酸化炭素が減り、BTB溶液は青色（アルカリ性側）になる。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "葉の表にワセリンを塗る目的は？", "c": ["表側の気孔をふさいで比べるため", "水の吸い上げを止めるため", "光合成を止めるため", "葉を枯らすため"], "a": 0, "desc": "ワセリンで気孔をふさいだ部分からは蒸散できない。表・裏でぬり分けて蒸散量を比べる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "昼の植物で多いはたらきは？", "c": ["光合成の量のほうが多い", "呼吸の量のほうが多い", "どちらも行わない", "つねに等しい"], "a": 0, "desc": "十分な光があるとき、光合成の量が呼吸の量を上回るため、全体として二酸化炭素を吸収し酸素を出す。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "根の吸収効率を上げるつくりは？", "c": ["葉緑体", "根毛", "維管束", "気孔"], "a": 1, "desc": "根毛は根の表皮細胞が細く伸びたもので、土と接する面積を広げて吸収を助ける。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "デンプンは何に変わって運ばれる？", "c": ["水にとけやすい糖", "酸素", "二酸化炭素", "タンパク質"], "a": 0, "desc": "デンプンは水にとけやすい糖に変えられて師管を通り、植物全体へ運ばれる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "赤い水で茎の断面が染まるのは？", "c": ["表皮", "気孔", "道管", "師管"], "a": 2, "desc": "水を運ぶ道管が赤く染まる。これにより道管の位置を確認できる。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "mid", "type": "choice", "q": "夜にデンプンが減る理由は？", "c": ["光合成で消えるから", "水にとけて気孔から出るから", "根にもどって種子になるから", "糖に変えられて運ばれたり使われたりするから"], "a": 3, "desc": "できたデンプンは糖に変えられて運ばれ、成長や呼吸に使われるため、夜の間に減っていく。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "senior", "type": "choice", "q": "被子と裸子を分ける基準は？", "c": ["胚珠が子房に包まれているかどうか", "花弁の色", "根がひげ根かどうか", "葉緑体があるかどうか"], "a": 0, "desc": "胚珠が子房に包まれていれば被子植物、むき出しなら裸子植物。これが分類の基準になる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "senior", "type": "choice", "q": "種子をつくらない仲間は？", "c": ["裸子植物", "単子葉類", "シダ植物・コケ植物", "被子植物"], "a": 2, "desc": "シダ植物とコケ植物は種子をつくらず胞子でふえる。種子植物（被子・裸子）とは大きく分けられる。"},
    ...
    {"subject": "biology", "genre": "bio_plant", "diff": "senior", "type": "choice", "q": "合弁花と離弁花の違いは？", "c": ["花弁がくっついているか離れているか", "子葉の枚数", "根のつくり", "葉脈の形"], "a": 0, "desc": "双子葉類は花弁がくっつく合弁花類（タンポポ・アサガオ）と、離れる離弁花類（アブラナ・サクラ）に分けられる。"},
    {"subject": "biology", "genre": "bio_plant", "diff": "senior", "type": "choice", "q": "CO2を吸収して見える理由は？", "c": ["師管がはたらかないから", "光合成の量が呼吸の量を上回るから", "呼吸をやめているから", "蒸散が止まるから"], "a": 1, "desc": "昼は呼吸もしているが、光合成のほうが多いため、差し引きで二酸化炭素を吸収しているように見える。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "アミラーゼを含む消化液は？", "c": ["胃液", "胆汁", "水", "だ液"], "a": 3, "desc": "だ液にはアミラーゼがふくまれ、デンプンを麦芽糖などに分解する。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "小腸で吸収面積を広げる突起は？", "c": ["じん臓", "毛細血管だけ", "柔毛（柔突起）", "肺胞"], "a": 2, "desc": "小腸のかべには多数の柔毛があり、表面積を広げて養分を効率よく吸収する。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "気管支の先につながる小袋は？", "c": ["肺胞", "柔毛", "じん臓", "ぼうこう"], "a": 0, "desc": "肺胞は小さなふくろで、まわりを毛細血管が取り囲み、表面積を広げて効率よくガス交換を行う。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "異物を取り除く血液成分は？", "c": ["赤血球", "血小板", "血しょう", "白血球"], "a": 3, "desc": "白血球は体内に入った細菌などをとらえて分解し、体を守る。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "子はえら、親は肺で呼吸する動物は？", "c": ["両生類", "魚類", "は虫類", "哺乳類"], "a": 0, "desc": "両生類（カエルなど）は子（オタマジャクシ）のときえらで、おとなになると肺と皮ふで呼吸する。"},
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "殻のある卵をうむ動物は？", "c": ["哺乳類", "は虫類", "両生類", "鳥類"], "a": 1, "desc": "は虫類（トカゲ・ヘビ・カメ）はうろこでおおわれ、陸上に殻のある卵をうむ。"},
    {"subject": "biology", "genre": "bio_human", "diff": "junior", "type": "choice", "q": "胎生の動物の仲間は？", "c": ["は虫類", "魚類", "哺乳類", "鳥類"], "a": 2, "desc": "哺乳類は胎生で、生まれた子は乳で育てられる。ほかの多くは卵をうむ卵生。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "デンプンは最後に何で吸収される？", "c": ["麦芽糖のまま", "ブドウ糖", "アミノ酸", "脂肪酸"], "a": 1, "desc": "デンプンは最終的にブドウ糖まで分解されて小腸から吸収される。タンパク質はアミノ酸まで分解される。"},
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "タンパク質は何で吸収される？", "c": ["脂肪酸とモノグリセリド", "麦芽糖", "アミノ酸", "ブドウ糖"], "a": 2, "desc": "タンパク質は消化酵素によってアミノ酸まで分解されてから吸収される。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "心臓と肺を往復する循環は？", "c": ["体循環", "門脈循環", "リンパ循環", "肺循環"], "a": 3, "desc": "心臓→肺→心臓の流れを肺循環、心臓→全身→心臓の流れを体循環という。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "酸素を受け取った血液の血管は？", "c": ["門脈", "肺静脈", "肺動脈", "大静脈"], "a": 1, "desc": "肺で酸素を受け取った血液（動脈血）は肺静脈を通って心臓にもどる。肺動脈には静脈血が流れる点に注意。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "尿をつくる器官は？", "c": ["かん臓", "すい臓", "ひ臓", "じん臓"], "a": 3, "desc": "じん臓は血液から尿素などの不要物をこし出して尿をつくる。尿はぼうこうにためられる。"},
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "アンモニアを尿素に変える器官は？", "c": ["かん臓", "じん臓", "すい臓", "ぼうこう"], "a": 0, "desc": "細胞でできた有害なアンモニアは、かん臓で害の少ない尿素に変えられ、じん臓で尿として排出される。"},
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "無意識に起こるすばやい反応は？", "c": ["感覚", "反射", "記憶", "意識的な反応"], "a": 1, "desc": "熱いものに思わず手を引っこめるような、意識とは無関係に起こる反応を反射という。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "脳とせきずいをまとめて何という？", "c": ["末しょう神経", "感覚神経", "運動神経", "中枢神経"], "a": 3, "desc": "脳とせきずいを中枢神経、そこから枝分かれする神経を末しょう神経という。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "mid", "type": "choice", "q": "腕を曲げ伸ばしする筋肉の働きは？", "c": ["筋肉は骨を動かさない", "一方が縮むと他方がゆるむ", "両方が同時に縮む", "両方が同時にゆるむ"], "a": 1, "desc": "うでには対になった筋肉があり、一方が縮むともう一方がゆるむことで曲げのばしができる。"},
    {"subject": "biology", "genre": "bio_human", "diff": "senior", "type": "choice", "q": "変温動物の組み合わせは？", "c": ["哺乳類・は虫類", "魚類・鳥類", "魚類・両生類・は虫類", "鳥類・哺乳類"], "a": 2, "desc": "魚類・両生類・は虫類は変温動物、鳥類・哺乳類は恒温動物。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "senior", "type": "choice", "q": "クジラが哺乳類とされる理由は？", "c": ["肺で呼吸し、子を乳で育てる", "水中でえら呼吸する", "うろこでおおわれている", "卵をうみ羽毛をもつ"], "a": 0, "desc": "クジラやイルカは水中にすむが、肺で呼吸し胎生で子を乳で育てるため哺乳類に分類される。"},
    {"subject": "biology", "genre": "bio_human", "diff": "senior", "type": "choice", "q": "節のある無脊椎動物は？", "c": ["環形動物", "節足動物", "軟体動物", "刺胞動物"], "a": 1, "desc": "こん虫やエビ・カニのように、からだやあしに節があり外骨格をもつなかまを節足動物という。"},
    {"subject": "biology", "genre": "bio_human", "diff": "senior", "type": "choice", "q": "外とう膜をもつ無脊椎動物は？", "c": ["セキツイ動物", "コケ動物", "軟体動物", "節足動物"], "a": 2, "desc": "イカ・タコ・貝などは外とう膜で内臓がおおわれた軟体動物。骨格をもたない。"},
    ...
    {"subject": "biology", "genre": "bio_human", "diff": "senior", "type": "choice", "q": "節足動物の硬い外側の骨格は？", "c": ["外骨格", "内骨格", "背骨", "外とう膜"], "a": 0, "desc": "節足動物はからだの外側に外骨格をもち、それを脱皮しながら成長する。セキツイ動物は内骨格をもつ。"},
    {"subject": "biology", "genre": "bio_human", "diff": "senior", "type": "choice", "q": "「見える」と感じる場所は？", "c": ["網膜だけ", "大脳", "せきずい", "運動神経"], "a": 1, "desc": "網膜で受け取った光の刺激は、視神経を通って大脳に伝わり、そこで「見える」と感じる。"},
    ...
    {"subject": "biology", "genre": "bio_cell", "diff": "mid", "type": "choice", "q": "核内で染まりやすいものは？", "c": ["葉緑体", "液胞", "細胞壁", "核"], "a": 3, "desc": "核は染色液（酢酸カーミン・酢酸オルセイン）で赤や青紫に染まる。中に遺伝に関わる染色体がある。"},
    ...
    {"subject": "biology", "genre": "bio_cell", "diff": "mid", "type": "choice", "q": "同じ働きの細胞の集まりは？", "c": ["器官系", "組織", "器官", "個体"], "a": 1, "desc": "細胞→組織→器官→個体の順にまとまっていく。同じはたらきの細胞の集まりが組織。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "mid", "type": "choice", "q": "組織が集まったまとまりは？", "c": ["細胞", "個体", "器官", "組織"], "a": 2, "desc": "胃や葉のように、いくつかの組織が集まって特定のはたらきをするものを器官という。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "mid", "type": "choice", "q": "養分からエネルギーを取り出す働きは？", "c": ["光合成", "蒸散", "消化", "細胞による呼吸"], "a": 3, "desc": "細胞は酸素を使って養分を分解しエネルギーを取り出す（細胞の呼吸）。このとき二酸化炭素と水ができる。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "mid", "type": "choice", "q": "葉の緑色の小さな粒は？", "c": ["葉緑体", "核", "液胞", "細胞壁"], "a": 0, "desc": "緑色の小さな粒は葉緑体で、光合成を行う。"},
    ...
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "受精せず体の一部からできる生殖は？", "c": ["無性生殖", "有性生殖", "受精", "減数分裂"], "a": 0, "desc": "ジャガイモのいもや、ミカヅキモの分裂のように、受精によらず親と同じ形質の子ができる生殖を無性生殖という。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "染色体数が半分になる分裂は？", "c": ["分化", "減数分裂", "体細胞分裂", "受精"], "a": 1, "desc": "卵や精子などの生殖細胞をつくるときの分裂を減数分裂といい、染色体の数が半分になる。受精で再びもとにもどる。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "染色体数が変わらない分裂は？", "c": ["受精", "分化", "体細胞分裂", "減数分裂"], "a": 2, "desc": "成長のとき体の細胞がふえる分裂を体細胞分裂といい、分裂の前後で染色体の数は変わらない。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "形質の情報をもつ物質は？", "c": ["タンパク質だけ", "デンプン", "ヘモグロビン", "DNA（遺伝子の本体）"], "a": 3, "desc": "染色体にふくまれる遺伝子の本体はDNA（デオキシリボ核酸）という物質である。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "同時に現れない形質どうしは？", "c": ["対立形質", "顕性形質", "潜性形質", "分離形質"], "a": 0, "desc": "丸としわのように、どちらか一方しか現れない対になる形質を対立形質という。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "AAとaaの子に現れる形質は？", "c": ["丸としわが3:1", "すべて丸", "すべてしわ", "丸としわが半分ずつ"], "a": 1, "desc": "丸が顕性（優性）形質なので、子（Aa）はすべて丸になる。しわは潜性（劣性）で子には現れない。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "Aaどうしの丸としわの比は？", "c": ["1:3", "すべて丸", "3:1", "1:1"], "a": 2, "desc": "Aa×Aaでは AA:Aa:aa＝1:2:1 となり、表に現れる形質は丸：しわ＝3:1になる。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "子に多く現れる形質は？", "c": ["潜性形質（劣性形質）", "中間形質", "分離形質", "顕性形質（優性形質）"], "a": 3, "desc": "子に現れるほうを顕性形質、現れず隠れるほうを潜性形質という。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "遺伝子が別々に入る法則は？", "c": ["分離の法則", "優性の法則", "独立の法則", "遺伝の法則"], "a": 0, "desc": "対になった遺伝子が分かれて別々の生殖細胞に入ることを分離の法則という。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "長い年月で新種が生じることは？", "c": ["分化", "進化", "成長", "遺伝"], "a": 1, "desc": "生物が長い時間をかけて変化し、新しい種類が生じることを進化という。"},
    {"subject": "biology", "genre": "bio_cell", "diff": "senior", "type": "choice", "q": "同じつくりからできた器官は？", "c": ["感覚器官", "生殖器官", "相同器官", "こん跡器官"], "a": 2, "desc": "現在のはたらきは違っても、もとは同じものから変化したと考えられる器官を相同器官という。進化の証拠とされる。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "生物と環境をまとめたものは？", "c": ["食物連鎖", "個体群", "分解者", "生態系"], "a": 3, "desc": "生物とそれを取りまく水・空気・土などの環境を一つのまとまりとして見たものを生態系という。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "食べる食べられるつながりは？", "c": ["食物連鎖", "生態系", "光合成", "呼吸"], "a": 0, "desc": "食べる・食べられるの関係が鎖のようにつながったものを食物連鎖という。実際は網の目状の食物網になる。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "光合成で有機物をつくる生物は？", "c": ["肉食動物", "生産者", "消費者", "分解者"], "a": 1, "desc": "植物のように光合成で養分をつくる生物を生産者という。それを食べる動物が消費者。"},
    ...
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "死がいやふんを分解する生物は？", "c": ["生産者", "草食動物", "肉食動物", "分解者"], "a": 3, "desc": "菌類や細菌類など、死がいやふんを無機物に分解する生物を分解者という。"},
    ...
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "数量ピラミッドで最も多いのは？", "c": ["大形の肉食動物", "植物（生産者）", "草食動物", "小形の肉食動物"], "a": 1, "desc": "生産者（植物）が最も数量が多く、上位の消費者になるほど少なくなり、ピラミッド型になる。"},
    ...
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "植物・動物以外の仲間は？", "c": ["岩石", "水", "空気", "菌類"], "a": 3, "desc": "生物には植物・動物のほか、カビやキノコのなかまである菌類などがいる。岩石・水・空気は生物ではない。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "junior", "type": "choice", "q": "生物を分類するよい方法は？", "c": ["共通点や相違点に注目して仲間に分ける", "大きさの順だけに並べる", "名前のあいうえお順に並べる", "見つけた順に並べる"], "a": 0, "desc": "分類では、からだのつくりやふえ方などの共通点・相違点に注目して、特徴の似たものを仲間に分ける。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "炭素を大気へ戻す主な働きは？", "c": ["受粉", "呼吸", "光合成", "蒸散"], "a": 1, "desc": "生物の呼吸によって、有機物の炭素が二酸化炭素として大気にもどる。光合成は逆に大気から取り込む。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "CO2を体に取り込む働きは？", "c": ["分解", "蒸散", "光合成", "呼吸"], "a": 2, "desc": "生産者の光合成によって、大気中の二酸化炭素が有機物として生物のからだに取りこまれる。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "加熱した土を使う目的は？", "c": ["養分を増やすため", "温度を上げて反応を速めるため", "水分を増やすため", "微生物がいる土と比べる対照にするため"], "a": 3, "desc": "加熱して微生物をいなくした土を対照とし、微生物のいる土と比べることで、分解が微生物によると確かめられる。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "菌類などが分解者と呼ばれる理由は？", "c": ["二酸化炭素や水などの無機物", "デンプンなどの有機物", "酸素だけ", "タンパク質"], "a": 0, "desc": "分解者は死がいやふんなどの有機物を二酸化炭素・水・無機の養分などに分解する。これが再び生産者に利用される。"},
    ...
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "外来種が起こす問題は？", "c": ["まったく影響しない", "分解者を増やして土を豊かにする", "もとからいた生物を減らし生態系のつり合いをくずすことがある", "必ず生態系を豊かにする"], "a": 2, "desc": "人間によってほかの地域から持ちこまれた外来種は、在来種を食べたり競争したりして生態系のつり合いをくずすことがある。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "食物連鎖のエネルギーのもとは？", "c": ["地熱", "風", "分解者", "太陽の光"], "a": 3, "desc": "生産者が光合成で太陽の光エネルギーを取りこむことで、生態系全体のエネルギーの流れが始まる。"},
    {"subject": "biology", "genre": "bio_eco", "diff": "mid", "type": "choice", "q": "デンプン分解を調べる薬品は？", "c": ["ヨウ素液（青紫にならなければ分解された）", "石灰水", "フェノールフタレイン液", "食塩水"], "a": 0, "desc": "デンプンが残っていればヨウ素液で青紫になる。色が変わらなければ、微生物のはたらきで分解されたとわかる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "地下で溶けた岩石は？", "c": ["れき", "マグマ", "溶岩", "火山灰"], "a": 1, "desc": "地下のとけた物質をマグマ、それが地表に出たものを溶岩という。"},
    ...
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "弱いマグマの噴火は？", "c": ["激しく爆発的な噴火が多い", "噴火しない", "必ず火山灰だけが出る", "おだやかに溶岩が流れ出すことが多い"], "a": 3, "desc": "ねばりけの弱いマグマはガスがぬけやすく、おだやかに溶岩を流す噴火になりやすい。"},
    ...
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "マグマが急冷した岩石は？", "c": ["れき岩", "火山岩", "深成岩", "堆積岩"], "a": 1, "desc": "地表近くで急に冷えた火成岩を火山岩という。結晶が大きく成長できず、斑状組織になる。"},
    ...
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "大結晶を細粒が囲む組織は？", "c": ["等粒状組織", "層状組織", "れき状組織", "斑状組織"], "a": 3, "desc": "火山岩は斑状組織。深成岩は大きな鉱物がそろった等粒状組織になる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "深成岩の大結晶組織は？", "c": ["等粒状組織", "斑状組織", "れき状組織", "化石組織"], "a": 0, "desc": "地下でゆっくり冷えると鉱物が大きく成長し、等粒状組織になる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "地震が発生した地下の場所は？", "c": ["プレート", "震源", "震央", "断層"], "a": 1, "desc": "地震が発生した地下の場所を震源、その真上の地表の点を震央という。"},
    ...
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "運ばれた土砂が積もることは？", "c": ["侵食", "運搬", "風化", "堆積"], "a": 3, "desc": "土砂が積もることを堆積、けずられることを侵食、運ばれることを運搬という。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "堆積して固まった岩石は？", "c": ["堆積岩", "火成岩", "火山岩", "深成岩"], "a": 0, "desc": "土砂などが固まってできた岩石を堆積岩という。れき岩・砂岩・泥岩・石灰岩などがある。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "河口まで運ばれやすい粒は？", "c": ["すべて同じ", "泥", "れき", "砂"], "a": 1, "desc": "粒の小さい泥は軽く、遠く深いところまで運ばれて堆積する。粒の大きいれきは河口近くに堆積する。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "年代を知る手がかりは？", "c": ["火山灰", "断層", "化石", "れき"], "a": 2, "desc": "化石は当時の生物の遺がいや活動のあとで、当時の環境（示相化石）や年代（示準化石）を知る手がかりになる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "地層がずれ動いたものは？", "c": ["しゅう曲", "整合", "風化", "断層"], "a": 3, "desc": "地層がずれたものを断層、波打つように曲がったものをしゅう曲という。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "塩酸で泡を出す堆積岩は？", "c": ["石灰岩", "砂岩", "泥岩", "チャート"], "a": 0, "desc": "石灰岩は炭酸カルシウムをふくみ、塩酸をかけると二酸化炭素を出してとける。チャートはとけない。"},
    {"subject": "earth", "genre": "earth_land", "diff": "junior", "type": "choice", "q": "岩石が長く崩れることは？", "c": ["噴火", "風化", "堆積", "地震"], "a": 1, "desc": "岩石が気温変化や水のはたらきでくずれていくことを風化という。風化した岩石は侵食・運搬されやすい。"},
    ...
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "初期微動が長いほど震源は？", "c": ["震源から遠いほど短くなる", "距離と関係しない", "つねに一定", "震源から遠いほど長くなる"], "a": 3, "desc": "P波とS波の速さの差から、震源から遠いほど初期微動継続時間は長くなる。これを使って震源距離を求められる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "P波S波の到着がずれる理由は？", "c": ["P波のほうがS波より速く伝わるから", "S波のほうが速いから", "震源が2つあるから", "波の大きさがちがうから"], "a": 0, "desc": "P波（初期微動）はS波（主要動）より速く伝わるため、遠い地点ほど到達時刻の差が大きくなる。"},
    ...
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "広域の火山灰層は？", "c": ["かぎ層（鍵層）", "断層", "整合", "しゅう曲"], "a": 0, "desc": "同じ時期に広く積もる火山灰の層などは、地層を対比するときの目印（かぎ層）になる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "環境を知る化石は？", "c": ["生痕", "示相化石", "示準化石", "標準化石"], "a": 1, "desc": "サンゴ（あたたかく浅い海）やシジミ（河口や湖）のように、当時の環境を示す化石を示相化石という。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "年代を知る化石は？", "c": ["生痕化石", "標本化石", "示準化石", "示相化石"], "a": 2, "desc": "広い範囲にすみ短い期間に栄えた生物の化石（アンモナイト・サンヨウチュウなど）は、年代を示す示準化石になる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "アンモナイトの時代は？", "c": ["古生代", "新生代", "現代", "中生代"], "a": 3, "desc": "アンモナイトは中生代の示準化石。サンヨウチュウは古生代、ビカリアやナウマンゾウは新生代の示準化石。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "サンヨウチュウの時代は？", "c": ["古生代", "中生代", "新生代", "先カンブリア時代だけ"], "a": 0, "desc": "サンヨウチュウは古生代の示準化石。中生代はアンモナイトや恐竜、新生代はナウマンゾウなどが代表的。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "下の地層ほど？", "c": ["まん中の層が最も古い", "下の層ほど古い", "上の層ほど古い", "どの層も同じ時期"], "a": 1, "desc": "地層は下から順に積み重なるので、ふつう下の層ほど古く、上の層ほど新しい。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "れき砂泥の違いは？", "c": ["化石の有無", "塩分のちがいだけ", "粒の大きさ（重さ）", "色のちがい"], "a": 2, "desc": "粒の大きい（重い）れきは河口近く、小さい（軽い）泥は遠く沖まで運ばれて堆積する。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "日本で地震が多い理由は？", "c": ["マグマだけ", "地下水", "火山灰", "プレート"], "a": 3, "desc": "日本付近では複数のプレートが動いてぶつかり合うため、ひずみがたまって地震が多く起こる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "mid", "type": "choice", "q": "海底地震の大波は？", "c": ["津波", "高潮", "液状化", "土石流"], "a": 0, "desc": "海底の地震などで海水が持ち上げられて起こる波を津波という。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "くり返し動く断層は？", "c": ["かぎ層", "活断層", "正断層だけ", "整合面"], "a": 1, "desc": "過去にくり返しずれ、今後も活動するおそれのある断層を活断層という。内陸の地震の原因になる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "深い海底の地形は？", "c": ["大陸だな", "三角州", "海溝", "海嶺"], "a": 2, "desc": "海のプレートがしずみこむ境界には深い海溝ができ、その付近では大きな地震が起こりやすい。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "地面が急に弱くなる現象は？", "c": ["風化", "しゅう曲", "堆積", "液状化"], "a": 3, "desc": "水を多くふくむ砂地などで、地震のゆれにより地面が液体のようになる現象を液状化という。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "波打つような地層変形は？", "c": ["しゅう曲", "断層", "整合", "液状化"], "a": 0, "desc": "地層が大きな力で押されて波打つように曲がったものをしゅう曲という。横からの力がはたらいた証拠になる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "途切れた地層の重なりは？", "c": ["かぎ層", "不整合", "しゅう曲", "活断層"], "a": 1, "desc": "堆積の中断や侵食をはさんで重なった地層の関係を不整合という。境界面（不整合面）が手がかりになる。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "水に浮く軽い噴出物は？", "c": ["黒曜石", "石灰岩", "軽石", "溶岩のかたまり"], "a": 2, "desc": "軽石はガスがぬけたあとのすき間が多く、軽くて水に浮くことがある。ねばりけの強いマグマからできやすい。"},
    {"subject": "earth", "genre": "earth_land", "diff": "senior", "type": "choice", "q": "花こう岩と流紋岩の違いは？", "c": ["ふくまれる化石のちがい", "地震の大きさ", "堆積した年代", "冷え方（できた場所）のちがい"], "a": 3, "desc": "花こう岩（深成岩）と流紋岩（火山岩）は成分が似るが、ゆっくり冷えたか急に冷えたかで組織が異なる。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "junior", "type": "choice", "q": "水滴になり始める温度は？", "c": ["凝固点", "露点", "沸点", "飽和点"], "a": 1, "desc": "空気を冷やして水蒸気が凝結し始める温度を露点という。露点が高いほど空気中の水蒸気が多い。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "junior", "type": "choice", "q": "水蒸気量の割合は？", "c": ["気圧", "降水量", "湿度", "気温"], "a": 2, "desc": "湿度（％）＝実際の水蒸気量÷その気温の飽和水蒸気量×100。空気のしめりぐあいを表す。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "junior", "type": "choice", "q": "気団の境界線は？", "c": ["前線", "等圧線", "等温線", "海岸線"], "a": 0, "desc": "暖気と寒気が接する境の面（前線面）が地表と交わる線を前線という。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "junior", "type": "choice", "q": "寒気が暖気を押し上げる前線は？", "c": ["閉そく前線", "寒冷前線", "温暖前線", "停滞前線"], "a": 1, "desc": "寒冷前線では寒気が暖気を急に押し上げ、積乱雲ができて短時間に強い雨が降りやすい。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "junior", "type": "choice", "q": "気温変化が大きい日は？", "c": ["晴れの日", "雨の日", "どちらも同じ", "くもりの日が最大"], "a": 0, "desc": "晴れの日は日射が地面を強く温め、夜は熱が逃げやすいので気温差が大きい。雲が多い日は差が小さい。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "junior", "type": "choice", "q": "湿球と乾球の温度差は？", "c": ["関係しない", "湿球のほうが低い（または等しい）", "湿球のほうが必ず高い", "つねに等しい"], "a": 1, "desc": "湿球は水の蒸発で熱がうばわれるため、乾球より低い温度を示す。差が大きいほど湿度は低い。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "冷やすと湿度は？", "c": ["高くなる", "低くなる", "変わらない", "必ず0になる"], "a": 0, "desc": "温度を下げると飽和水蒸気量が小さくなるため、同じ水蒸気量でも湿度は高くなる。露点で100％になる。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "短時間の強い雨の雲は？", "c": ["巻雲", "うろこ雲", "積乱雲", "乱層雲"], "a": 2, "desc": "寒冷前線では暖気が急に押し上げられ、積乱雲が発達して短時間の強い雨やかみなりをもたらす。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "広く長い雨の雲は？", "c": ["積乱雲", "積雲", "巻積雲", "乱層雲"], "a": 3, "desc": "温暖前線では暖気がゆるやかにはい上がり、乱層雲などが広がって弱い雨が長く降りやすい。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "昼に海から陸へ吹く風は？", "c": ["海風", "陸風", "季節風", "偏西風"], "a": 0, "desc": "昼は陸があたたまりやすく上昇気流が生じ、海から陸へ海風がふく。夜は逆に陸風がふく。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "冬の季節風の主因は？", "c": ["梅雨前線ができるから", "シベリア高気圧が発達するから", "太平洋高気圧が発達するから", "台風が多いから"], "a": 1, "desc": "冬はシベリア高気圧が発達し、そこから北西の季節風がふく。日本海側に雪、太平洋側に乾いた晴れをもたらす。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "夏の高温多湿な気団は？", "c": ["オホーツク海気団", "移動性高気圧", "太平洋高気圧（小笠原気団）", "シベリア高気圧"], "a": 2, "desc": "夏は太平洋高気圧（小笠原気団）が発達し、南東の季節風とともに蒸し暑い晴天をもたらす。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "mid", "type": "choice", "q": "梅雨の時期の前線は？", "c": ["寒冷前線", "温暖前線", "閉そく前線", "停滞前線（梅雨前線）"], "a": 3, "desc": "勢力の似た気団が接してほとんど動かない前線を停滞前線といい、梅雨や秋雨をもたらす。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "senior", "type": "choice", "q": "西から東へ動かす風は？", "c": ["貿易風", "季節風", "海風", "偏西風"], "a": 3, "desc": "中緯度の上空を西から東へふく偏西風によって、日本の天気はおおむね西から東へ変わる。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "senior", "type": "choice", "q": "春秋に天気が周期変化する理由は？", "c": ["偏西風で西から東へ次々に移動してくるから", "台風が多いから", "季節風が強いから", "停滞前線が居すわるから"], "a": 0, "desc": "春・秋は移動性高気圧と低気圧が偏西風に流されて交互に通過するため、天気が数日の周期で変わりやすい。"},
    {"subject": "earth", "genre": "earth_weather", "diff": "senior", "type": "choice", "q": "日本海側の雪と太平洋側の晴れはなぜ？", "c": ["偏西風がふかないから", "季節風が日本海で水蒸気を得て山地で雪を降らせ、太平洋側では乾くから", "台風が来るから", "梅雨前線のため"], "a": 1, "desc": "冬の北西季節風は日本海で水蒸気を得て、山地にぶつかって日本海側に雪を降らせ、山をこえると乾いた風になる。"},
    ...
    {"subject": "earth", "genre": "earth_weather", "diff": "senior", "type": "choice", "q": "同じ湿度で水蒸気が多い空気は？", "c": ["気温が低いほうが多い", "つねに同じ", "湿度だけで決まる", "気温が高いほうが多い"], "a": 3, "desc": "湿度が同じでも飽和水蒸気量は気温が高いほど大きいので、気温が高い空気のほうが実際にふくむ水蒸気量は多い。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "太陽の動きは地球の何による？", "c": ["大気の動き", "星自身の運動", "自転", "公転"], "a": 2, "desc": "地球が西から東へ自転しているため、太陽や星は見かけ上、東から西へ動いて見える（日周運動）。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "太陽の1日の記録は？", "c": ["等しい間隔で並ぶ", "だんだんせまくなる", "ばらばらになる", "1点に集まる"], "a": 0, "desc": "太陽は一定の速さで動いて見えるため、一定時間ごとの記録点は等間隔に並ぶ。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "北極星が動かない理由は？", "c": ["大気がゆれるから", "地球が自転しているから", "星が地球のまわりを回るから", "地球が公転するから"], "a": 1, "desc": "地軸の延長近くに北極星があるため、地球の自転によって星は北極星を中心に反時計回りに回って見える。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "星座が月ごと西へずれる理由は？", "c": ["月の満ち欠け", "太陽の自転", "地球の公転", "地球の自転"], "a": 2, "desc": "地球の公転により、同じ時刻に見える星座は1か月で約30°西へずれる（年周運動）。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "真夜中南の星座の位置は？", "c": ["太陽と同じ方向", "太陽の真横（東）", "太陽の真横（西）", "太陽と反対の方向"], "a": 3, "desc": "真夜中に南中する星座は、地球をはさんで太陽と反対側にある。だから季節ごとに見える星座が変わる。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "自ら光らない大天体は？", "c": ["星座", "惑星", "恒星", "衛星"], "a": 1, "desc": "太陽のまわりを公転する天体を惑星という。地球・金星・火星などがある。衛星は惑星のまわりを回る。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "月は地球の何か？", "c": ["惑星", "すい星", "衛星", "恒星"], "a": 2, "desc": "惑星のまわりを回る天体を衛星という。月は地球の衛星である。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "太陽表面の黒い部分は？", "c": ["プロミネンス", "コロナ", "クレーター", "黒点"], "a": 3, "desc": "黒点はまわりより温度が低い（約4000℃）ため黒く見える。位置の移動から太陽の自転がわかる。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "黒点の移動でわかることは？", "c": ["太陽も自転している", "太陽が地球を回る", "黒点が動く生き物である", "地球が止まっている"], "a": 0, "desc": "黒点が一定方向に移動して見えることから、太陽自身も自転していることがわかる。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "月面の丸いくぼみは？", "c": ["海溝", "クレーター", "黒点", "プロミネンス"], "a": 1, "desc": "月の表面のクレーターは、いん石などの衝突でできたと考えられている。"},
    {"subject": "earth", "genre": "earth_space", "diff": "mid", "type": "choice", "q": "月の満ち欠けの原因は？", "c": ["地球の自転", "月の自転だけ", "月の公転による太陽・地球・月の位置関係の変化", "月がみずから光る量の変化"], "a": 2, "desc": "月が地球のまわりを公転し、太陽・地球・月の位置関係が変わるため、光って見える部分が変化して満ち欠けする。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "夏至の南中高度が高い理由は？", "c": ["地軸が公転面に対して傾いたまま公転しているから", "地球が太陽に最も近いから", "太陽が大きくなるから", "自転が速くなるから"], "a": 0, "desc": "地軸が傾いたまま公転するため、夏は太陽の南中高度が高く昼が長い。季節の変化の原因はこの地軸の傾き。"},
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "冬至の昼と南中高度は？", "c": ["変化しない", "昼が短く、南中高度が低い", "昼が長く、南中高度が高い", "昼夜が等しく高度も最大"], "a": 1, "desc": "冬至は太陽の南中高度が最も低く、昼の長さも最も短い。受ける日射が弱く気温が下がりやすい。"},
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "金星が真夜中見えない理由は？", "c": ["金星が遠すぎるから", "金星に大気がないから", "金星が地球より内側を公転しているから", "金星がみずから光らないから"], "a": 2, "desc": "金星は地球より内側（太陽側）を公転する内惑星なので、太陽から大きく離れて見えず、真夜中の空には見えない。"},
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "金星の満ち欠けの主因は？", "c": ["金星がみずから光るから", "金星の自転", "地球の公転だけ", "金星と地球の距離・位置関係が変化するから"], "a": 3, "desc": "金星は地球との距離や太陽との位置関係が変わるため、満ち欠けし見かけの大きさも変化する。近いほど大きく細く見える。"},
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "太陽が月に隠される現象は？", "c": ["日食", "月食", "満月", "南中"], "a": 0, "desc": "太陽−月−地球が一直線に並び、月が太陽をかくすのが日食。新月のときに起こる。"},
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "月が地球の影に入る現象は？", "c": ["日周運動", "月食", "日食", "新月"], "a": 1, "desc": "太陽−地球−月の順に並び、月が地球の影に入るのが月食。満月のときに起こる。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "密度が小さい巨大惑星は？", "c": ["地球型惑星", "小惑星", "衛星", "木星型惑星"], "a": 3, "desc": "木星・土星などはおもに気体からなり大きく密度が小さい木星型惑星。地球・火星などは岩石主体で小さい地球型惑星。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "数千億の恒星の大集団は？", "c": ["星団のみ", "銀河系（天の川銀河）", "太陽系", "星座"], "a": 1, "desc": "太陽系をふくむ恒星の大集団が銀河系。地球から見た銀河系の断面が天の川として見える。"},
    ...
    {"subject": "earth", "genre": "earth_space", "diff": "senior", "type": "choice", "q": "ほとんど動かない北の星は？", "c": ["北極星", "シリウス", "ベテルギウス", "金星"], "a": 0, "desc": "北極星は地軸の延長近くにあるため、ほぼ動かず、ほかの星はその北極星を中心に回って見える。"},
    ...
    {"subject": "chemistry", "genre": "formula", "diff": "junior", "type": "choice", "name": "物質をつくる最小の粒子", "q": "物質を作る最小粒子は？", "c": ["原子", "分子", "イオン", "電子"], "a": 0, "desc": "物質をつくる最小の粒子を原子という。原子がいくつか結びついたものが分子。"},
    {"subject": "chemistry", "genre": "formula", "diff": "junior", "type": "choice", "name": "分子", "q": "性質を示すまとまりは？", "c": ["混合物", "分子", "原子核", "元素"], "a": 1, "desc": "分子は原子が結びついた粒子で、その物質の性質を示す最小のまとまり。水分子や酸素分子など。"},
    ...
    {"subject": "chemistry", "genre": "formula", "diff": "mid", "type": "choice", "name": "分子をつくらない物質", "q": "塩化ナトリウムの特徴は？", "c": ["多数の原子（イオン）が規則正しく並んでいる", "1個の分子で性質が決まる", "原子が存在しない", "気体である"], "a": 0, "desc": "塩化ナトリウムや金属は分子をつくらず、多数の原子やイオンが規則正しく並んでいる。"},
    ...
    {"subject": "chemistry", "genre": "reaction", "diff": "junior", "type": "choice", "name": "分解", "q": "1種類に分かれる変化は？", "c": ["還元", "中和", "分解", "化合"], "a": 2, "desc": "1種類の物質が複数に分かれる変化が分解。加熱や電流によって起こる。"},
    ...
    {"subject": "chemistry", "genre": "reaction", "diff": "junior", "type": "choice", "name": "化合", "q": "結びついて1つになる変化は？", "c": ["還元", "蒸発", "化合", "分解"], "a": 2, "desc": "鉄と硫黄が結びついて硫化鉄ができるように、結びついて別の物質ができる変化を化合という。"},
    {"subject": "chemistry", "genre": "reaction", "diff": "junior", "type": "choice", "name": "質量保存の法則", "q": "反応前後で保たれる量は？", "c": ["定比例の法則", "フックの法則", "オームの法則", "質量保存の法則"], "a": 3, "desc": "化学変化の前後で原子の数や種類は変わらないため、全体の質量は保存される（質量保存の法則）。"},
    {"subject": "chemistry", "genre": "reaction", "diff": "junior", "type": "choice", "name": "発熱反応", "q": "熱を出す反応は？", "c": ["発熱反応", "吸熱反応", "中和", "分解"], "a": 0, "desc": "熱を放出する反応が発熱反応（鉄の酸化を利用したかいろなど）。熱を吸収するのが吸熱反応。"},
    ...
    {"subject": "chemistry", "genre": "reaction", "diff": "mid", "type": "choice", "name": "炭素のはたらき", "q": "酸化銅中の炭素の働きは？", "c": ["酸化銅から酸素をうばう（還元する）", "酸化銅に酸素を与える", "銅を蒸発させる", "変化しない"], "a": 0, "desc": "炭素は酸化銅から酸素をうばって自分は二酸化炭素になる。酸化銅は還元されて銅になる。"},
    {"subject": "chemistry", "genre": "reaction", "diff": "mid", "type": "choice", "name": "反応式の意味", "q": "反応式で等しくする物は？", "c": ["色の濃さ", "原子の種類と数", "分子の個数", "物質の体積"], "a": 1, "desc": "化学変化では原子は新たに生じたり消えたりしないので、反応式の左右で原子の種類と数は等しい。"},
    {"subject": "chemistry", "genre": "reaction", "diff": "mid", "type": "choice", "name": "密閉容器の質量", "q": "反応前後の質量は？", "c": ["減る", "半分になる", "変わらない", "増える"], "a": 2, "desc": "気体がにげなければ、質量保存の法則どおり反応前後の質量は変わらない。ふたを開けて気体がにげると減る。"},
    ...
    {"subject": "chemistry", "genre": "reaction", "diff": "mid", "type": "choice", "name": "鉄と硫黄の化合", "q": "硫化鉄の性質は？", "c": ["もとの鉄とは性質がちがい、磁石につきにくい", "鉄と同じく磁石によくつく", "塩酸と反応しない", "気体である"], "a": 0, "desc": "化合してできた硫化鉄は、もとの鉄や硫黄とは性質がちがう。磁石につきにくく、塩酸と反応して硫化水素（卵のくさったにおい）を出す。"},
    {"subject": "chemistry", "genre": "reaction", "diff": "senior", "type": "choice", "name": "中和", "q": "酸とアルカリの反応は？", "c": ["分解", "中和", "酸化", "還元"], "a": 1, "desc": "酸とアルカリを混ぜると、水素イオンと水酸化物イオンが結びついて水ができ、たがいの性質を打ち消す（中和）。"},
    {"subject": "chemistry", "genre": "reaction", "diff": "senior", "type": "choice", "name": "塩", "q": "中和でできる物質は？", "c": ["アルカリ", "水", "塩（えん）", "酸"], "a": 2, "desc": "中和では水とともに塩ができる。塩酸と水酸化ナトリウムの中和では塩化ナトリウムが塩になる。"},
    ...
    {"subject": "chemistry", "genre": "ion", "diff": "junior", "type": "choice", "name": "電離", "q": "電解質が水中で分かれる現象は？", "c": ["蒸発", "中和", "還元", "電離"], "a": 3, "desc": "電解質が水にとけてイオンに分かれることを電離という。これにより水溶液に電流が流れる。"},
    {"subject": "chemistry", "genre": "ion", "diff": "mid", "type": "choice", "name": "酸性のイオン", "q": "酸性を示すイオンは？", "c": ["水素イオン H⁺", "水酸化物イオン OH⁻", "ナトリウムイオン Na⁺", "塩化物イオン Cl⁻"], "a": 0, "desc": "酸性の正体は水素イオン H⁺。アルカリ性の正体は水酸化物イオン OH⁻。"},
    {"subject": "chemistry", "genre": "ion", "diff": "mid", "type": "choice", "name": "アルカリ性のイオン", "q": "アルカリ性を示すイオンは？", "c": ["銅イオン Cu²⁺", "水酸化物イオン OH⁻", "水素イオン H⁺", "塩化物イオン Cl⁻"], "a": 1, "desc": "アルカリ性の正体は水酸化物イオン OH⁻。水酸化ナトリウム水溶液などにふくまれる。"},
    {"subject": "chemistry", "genre": "ion", "diff": "mid", "type": "choice", "name": "pH", "q": "水溶液の性質の数値は？", "c": ["密度", "電力", "pH", "質量パーセント濃度"], "a": 2, "desc": "pHは7が中性、7より小さいと酸性、7より大きいとアルカリ性。"},
    ...
    {"subject": "chemistry", "genre": "ion", "diff": "mid", "type": "choice", "name": "塩化銅水溶液の電気分解", "q": "塩化銅の電気分解で出る赤い物質は？", "c": ["水素", "酸素", "銅", "塩素"], "a": 2, "desc": "塩化銅水溶液の電気分解では陰極に銅が付着し、陽極から塩素が発生する。"},
    {"subject": "chemistry", "genre": "ion", "diff": "mid", "type": "choice", "name": "化学電池", "q": "電解質水溶液で電流を作る装置は？", "c": ["電気分解装置", "光電池", "コンデンサー", "化学電池"], "a": 3, "desc": "2種類の金属と電解質水溶液で電流をとり出す装置を化学電池という。化学エネルギーを電気エネルギーに変える。"},
    ...
    {"subject": "chemistry", "genre": "experiment", "diff": "junior", "type": "choice", "name": "水素の確認", "q": "音を立てて燃える気体は？", "c": ["酸素", "二酸化炭素", "アンモニア", "水素"], "a": 3, "desc": "水素は火を近づけるとポンと音を立てて燃え、水ができる。"},
    ...
    {"subject": "chemistry", "genre": "experiment", "diff": "junior", "type": "choice", "name": "上皿てんびん", "q": "てんびんで皿にのせる位置は？", "c": ["のせなくてよい", "はかりとる薬品と反対側の皿", "薬品と同じ側の皿", "両方の皿"], "a": 1, "desc": "決まった質量をはかりとるときは、反対側の皿に分銅をのせ、つり合うまで薬品を加える。"},
    ...
    {"subject": "chemistry", "genre": "experiment", "diff": "mid", "type": "choice", "name": "アンモニアの集め方", "q": "アンモニアの捕集法は？", "c": ["下方置換法", "水上置換法", "ろ過", "上方置換法"], "a": 3, "desc": "アンモニアは水によくとけ空気より軽いので、上方置換法で集める。"},
    {"subject": "chemistry", "genre": "experiment", "diff": "mid", "type": "choice", "name": "二酸化炭素の集め方", "q": "二酸化炭素の捕集法は？", "c": ["下方置換法（または水上置換法）", "上方置換法だけ", "必ず上方置換法", "集められない"], "a": 0, "desc": "二酸化炭素は空気より重いので下方置換法で集められる。水に少ししかとけないため水上置換法でも集められる。"},
    ...
    {"subject": "chemistry", "genre": "experiment", "diff": "mid", "type": "choice", "name": "蒸留", "q": "液体から気体にして戻す方法は？", "c": ["再結晶", "電気分解", "蒸留", "ろ過"], "a": 2, "desc": "沸点のちがいを利用して液体を分ける方法が蒸留。水とエタノールの混合物を分けるときなどに使う。"},
    {"subject": "chemistry", "genre": "experiment", "diff": "mid", "type": "choice", "name": "再結晶", "q": "温度差で結晶を得る方法は？", "c": ["ろ過", "蒸留", "中和", "再結晶"], "a": 3, "desc": "物質が温度によってとける量がちがうことを利用して、純粋な結晶を取り出す方法を再結晶という。"},
    {"subject": "chemistry", "genre": "experiment", "diff": "mid", "type": "choice", "name": "メスシリンダーの読み方", "q": "液量はどこを読む？", "c": ["液面のへこんだ底を真横から", "液面の上のふちを上から", "底から見上げる", "どこでもよい"], "a": 0, "desc": "液面のへこんだ部分（メニスカス）の底を、真横から目の高さを合わせて読む。"},
    ...
    {"subject": "physics", "genre": "light_sound", "diff": "junior", "type": "choice", "q": "反射角と入射角は？", "c": ["入射角のほうが大きい", "反射角のほうが大きい", "関係はない", "つねに等しい"], "a": 3, "desc": "反射の法則により、入射角と反射角はつねに等しい。"},
    {"subject": "physics", "genre": "light_sound", "diff": "junior", "type": "choice", "q": "光の境界での現象は？", "c": ["屈折", "反射", "直進", "振動"], "a": 0, "desc": "光が異なる物質へ進むとき境界で折れ曲がることを屈折という。水中のものが浮いて見えるのはこのため。"},
    {"subject": "physics", "genre": "light_sound", "diff": "junior", "type": "choice", "q": "水中→空気の全反射名は？", "c": ["分散", "全反射", "乱反射", "屈折"], "a": 1, "desc": "水中（ガラス中）から空気中へ進むとき、ある角度をこえると光がすべて反射する全反射が起こる。光ファイバーに利用される。"},
    ...
    {"subject": "physics", "genre": "light_sound", "diff": "mid", "type": "choice", "q": "焦点外でできる像は？", "c": ["虚像（正立）", "像はできない", "光源像", "実像（上下左右が逆）"], "a": 3, "desc": "焦点の外側に物体があると、上下左右が逆の実像がスクリーンにできる。"},
    {"subject": "physics", "genre": "light_sound", "diff": "mid", "type": "choice", "q": "虫眼鏡の焦点内の像は？", "c": ["正立で拡大した虚像", "倒立した実像", "同じ大きさの実像", "像はできない"], "a": 0, "desc": "焦点の内側に物体を置くと、正立で拡大した虚像が見える。虫めがねで大きく見えるのはこのため。"},
    ...
    {"subject": "physics", "genre": "light_sound", "diff": "mid", "type": "choice", "q": "真空中の音は？", "c": ["光になって伝わる", "一瞬だけ伝わる", "伝わらない", "よりよく伝わる"], "a": 2, "desc": "音は振動を伝える物質（媒質）が必要なので、真空中では伝わらない。"},
    ...
    {"subject": "physics", "genre": "force", "diff": "junior", "type": "choice", "q": "ばねの伸びの法則は？", "c": ["オームの法則", "慣性の法則", "作用反作用の法則", "フックの法則"], "a": 3, "desc": "ばねののびは加えた力に比例する（フックの法則）。これを利用したのがばねばかり。"},
    ...
    {"subject": "physics", "genre": "force", "diff": "junior", "type": "choice", "q": "面積あたりの力は？", "c": ["重力", "浮力", "磁力", "圧力"], "a": 3, "desc": "単位面積あたりにはたらく力を圧力という。圧力＝力÷面積。単位はPa（パスカル）。"},
    ...
    {"subject": "physics", "genre": "electricity", "diff": "junior", "type": "choice", "q": "分かれ道なし回路名は？", "c": ["開回路", "直列回路", "並列回路", "短絡回路"], "a": 1, "desc": "電流の通り道が1本道の回路が直列回路。途中で枝分かれする回路が並列回路。"},
    {"subject": "physics", "genre": "electricity", "diff": "junior", "type": "choice", "q": "直列回路の電流は？", "c": ["電源に近いほど大きい", "電源から遠いほど大きい", "どの点でも同じ", "枝ごとに分かれる"], "a": 2, "desc": "直列回路では、電流は枝分かれしないのでどの点でも同じ大きさになる。"},
    ...
    {"subject": "physics", "genre": "electricity", "diff": "mid", "type": "choice", "q": "1秒あたり電気エネは？", "c": ["抵抗（単位Ω）", "電圧（単位V）", "電力（単位W）", "電力量（単位J）"], "a": 2, "desc": "1秒あたりに使う電気エネルギーが電力で、単位はW（ワット）。電力＝電圧×電流。"},
    ...
    {"subject": "physics", "genre": "electricity", "diff": "senior", "type": "choice", "q": "磁界中の電流装置は？", "c": ["変圧器", "電池", "モーター", "発電機だけ"], "a": 2, "desc": "磁界中の電流が受ける力を利用してコイルを回転させるのがモーター。逆に磁界の変化で電流を得るのが発電機。"},
    ...
    {"subject": "physics", "genre": "motion", "diff": "mid", "type": "choice", "q": "力なしで保つ性質は？", "c": ["慣性", "弾性", "摩擦", "浮力"], "a": 0, "desc": "物体が運動の状態を保とうとする性質が慣性。バスが急発進すると体が後ろにかたむくのはこのため。"},
    {"subject": "physics", "genre": "motion", "diff": "mid", "type": "choice", "q": "押し返す力の関係は？", "c": ["てこの原理", "作用・反作用", "2力のつり合い", "慣性"], "a": 1, "desc": "一方が力を加えると、相手も同じ大きさで反対向きの力を加え返す（作用・反作用の法則）。"},
    ...
    {"subject": "physics", "genre": "motion", "diff": "senior", "type": "choice", "q": "仕事の求め方は？", "c": ["力＋距離", "距離÷時間", "力の大きさ×力の向きに動いた距離", "力÷距離"], "a": 2, "desc": "仕事（J）＝力（N）×力の向きに動いた距離（m）。動かなければ仕事は0。"},
    {"subject": "physics", "genre": "motion", "diff": "senior", "type": "choice", "q": "高さで持つエネは？", "c": ["運動エネルギー", "熱エネルギー", "弾性エネルギー", "位置エネルギー"], "a": 3, "desc": "高い所にある物体がもつエネルギーが位置エネルギー。高さが高いほど、質量が大きいほど大きい。"},
    ...
    {"subject": "physics", "genre": "motion", "diff": "senior", "type": "choice", "q": "位置＋運動エネの和は？", "c": ["仕事率", "力学的エネルギー", "熱量", "電力量"], "a": 1, "desc": "位置エネルギーと運動エネルギーの和が力学的エネルギー。摩擦などがなければ一定に保たれる（力学的エネルギーの保存）。"},
    {"subject": "physics", "genre": "motion", "diff": "senior", "type": "choice", "q": "道具でも仕事量は？", "c": ["作用反作用の法則", "フックの法則", "仕事の原理", "慣性の法則"], "a": 2, "desc": "道具を使うと力は小さくできるが動かす距離が長くなり、仕事の量は変わらない（仕事の原理）。"},
    ...
    {"subject": "chemistry", "genre": "reaction", "diff": "supreme", "type": "choice", "name": "酸化銅の質量", "q": "銅0.8gの酸化銅は？", "c": ["0.2g", "1.0g", "0.8g", "1.6g"], "a": 1, "desc": "酸素0.2gが加わる。"},
    ...
    {"subject": "chemistry", "genre": "ion", "diff": "supreme", "type": "choice", "name": "ちょうど中和", "q": "中和後の水溶液の性質は？", "c": ["アルカリ性", "決まらない", "中性", "酸性"], "a": 2, "desc": "H⁺とOH⁻が等しい。"},
    ...
    { subject:'chemistry', genre:'matter', diff:'junior', type:'choice', name:'凝縮', q:'水滴は水蒸気が何になった？', c:['氷','水蒸気','水','金属'], a:2, desc:'気体の水蒸気が液体の水になる変化を凝縮といいます。' },
    ...
    { subject:'chemistry', genre:'matter', diff:'junior', type:'choice', name:'有機物', q:'燃やすと二酸化炭素を出す物質は？', c:['金属','無機物','水溶液','有機物'], a:3, desc:'多くの有機物は炭素を含み、燃やすと二酸化炭素を出します。' },
    ...
    { subject:'chemistry', genre:'matter', diff:'mid', type:'choice', name:'再結晶', q:'結晶として取り出す方法は？', c:['蒸発','昇華','再結晶','燃焼'], a:2, desc:'温度による溶解度の差を利用して結晶を取り出す方法を再結晶といいます。' },
    ...
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'中和', q:'酸とアルカリの反応は？', c:['酸化','還元','蒸留','中和'], a:3, desc:'酸とアルカリが反応して、互いの性質を弱める反応を中和という。' },
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'中和でできる水', q:'H+とOH-でできる物は？', c:['酸素','水','水素','塩化水素'], a:1, desc:'H+とOH-が結びつくとH2O、つまり水ができる。' },
    ...
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'塩酸の電離', q:'HClの電離でできる組合せは？', c:['Na+ と Cl-','H+ と OH-','Cu2+ と Cl-','H+ と Cl-'], a:3, desc:'塩化水素は水中でH+とCl-に分かれる。' },
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'水酸化ナトリウムの電離', q:'NaOHの電離でできる組合せは？', c:['Na+ と OH-','H+ と Cl-','Na+ と Cl-','Cu2+ と OH-'], a:0, desc:'NaOHは水中でNa+とOH-に分かれる。' },
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'硫酸の電離', q:'H2SO4の陰イオンは？', c:['Cl-','SO42-','NO3-','OH-'], a:1, desc:'硫酸からは水素イオンと硫酸イオンSO42-ができる。' },
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'硝酸銀と塩化物イオン', q:'Cl-でできる白い沈殿は？', c:['硫酸バリウム','酸化銅','塩化銀','炭酸カルシウム'], a:2, desc:'Ag+とCl-が結びつくと、水に溶けにくい白色の塩化銀ができる。' },
    { subject:'chemistry', genre:'ion', diff:'mid', type:'choice', name:'硫酸イオンの確認', q:'SO42-でできる白い沈殿は？', c:['塩化銀','水酸化銅','塩化ナトリウム','硫酸バリウム'], a:3, desc:'Ba2+とSO42-が結びつくと、白色の硫酸バリウムが沈殿する。' },
    ...
    // ── 物理 運動・エネルギー バッチP4 2026-06-05 Codex生成→Claude QA(全93問・速さ/仕事/仕事率/エネルギー計算46問を1問ずつ検算・全正)→マージ＝物理完了。
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'速さの意味', q:'速さで比べるものはどれ？', c:['単位時間の距離','物体の重さ','力の大きさ','温度の高さ'], a:0, desc:'速さは1秒や1時間に進む距離で表す。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'速さの単位', q:'速さの単位はどれ？', c:['N','J','Pa','m/s'], a:3, desc:'m/sは1秒あたりに進むmを表す。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'平均の速さ', q:'平均の速さの式はどれ？', c:['時間÷距離','距離×時間','力×距離','距離÷時間'], a:3, desc:'平均の速さ=進んだ距離÷かかった時間。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'等速直線運動', q:'等速直線運動の特徴は？', c:['向きだけ変わる','速さが一定','速さが増える','速さが減る'], a:1, desc:'一直線上を一定の速さで進む運動。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'距離と時間', q:'等速運動で時間が2倍なら距離は？', c:['4倍','半分','変わらない','2倍'], a:3, desc:'速さが一定なら距離は時間に比例する。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'記録タイマー', q:'記録タイマーの点間が広がる運動は？', c:['速くなる','止まる','一定の速さ','遅くなる'], a:0, desc:'同じ時間ごとの距離が大きいほど速い。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'点間一定', q:'記録タイマーの点間が同じなら？', c:['落下中','速さ一定','だんだん速い','だんだん遅い'], a:1, desc:'同じ時間に同じ距離を進むので速さは一定。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'自由落下', q:'自由落下で速さはどうなる？', c:['一定','遅くなる','速くなる','すぐ止まる'], a:2, desc:'重力により下向きの速さが増す。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'自由落下の力', q:'自由落下で物体にはたらく力は？', c:['上向きの力','重力','摩擦力だけ','力はない'], a:1, desc:'空気抵抗を除けば重力だけが下向きにはたらく。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'慣性', q:'慣性とはどんな性質？', c:['温度を保つ','形を変える','電気を通す','運動状態を保つ'], a:3, desc:'物体は止まり続けたり動き続けたりしようとする。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'急ブレーキ', q:'車の急ブレーキで体が前に動く理由は？', c:['浮力','磁力','圧力','慣性'], a:3, desc:'体は前向きの運動を続けようとする。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'choice', name:'速さの比較', q:'同じ距離を短時間で進む物体は？', c:['軽い','遅い','速い','重い'], a:2, desc:'距離が同じなら時間が短いほど速い。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'72mを9秒で進む速さ(m/s)', formula:'8', plain:true, desc:'速さ=距離÷時間。72÷9=8。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'96mを12秒で進む速さ(m/s)', formula:'8', plain:true, desc:'速さ=距離÷時間。96÷12=8。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'84mを7秒で進む速さ(m/s)', formula:'12', plain:true, desc:'速さ=距離÷時間。84÷7=12。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'45mを5秒で進む速さ(m/s)', formula:'9', plain:true, desc:'速さ=距離÷時間。45÷5=9。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'180mを30秒で進む速さ(m/s)', formula:'6', plain:true, desc:'速さ=距離÷時間。180÷30=6。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'240mを40秒で進む速さ(m/s)', formula:'6', plain:true, desc:'速さ=距離÷時間。240÷40=6。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'200mを25秒で進む速さ(m/s)', formula:'8', plain:true, desc:'速さ=距離÷時間。200÷25=8。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'150mを15秒で進む速さ(m/s)', formula:'10', plain:true, desc:'速さ=距離÷時間。150÷15=10。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'210mを30秒で進む速さ(m/s)', formula:'7', plain:true, desc:'速さ=距離÷時間。210÷30=7。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'132mを11秒で進む速さ(m/s)', formula:'12', plain:true, desc:'速さ=距離÷時間。132÷11=12。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'300mを50秒で進む速さ(m/s)', formula:'6', plain:true, desc:'速さ=距離÷時間。300÷50=6。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'54mを6秒で進む速さ(m/s)', formula:'9', plain:true, desc:'速さ=距離÷時間。54÷6=9。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'168mを14秒で進む速さ(m/s)', formula:'12', plain:true, desc:'速さ=距離÷時間。168÷14=12。' },
    { subject:'physics', genre:'motion', diff:'mid', type:'typing', name:'80mを16秒で進む速さ(m/s)', formula:'5', plain:true, desc:'速さ=距離÷時間。80÷16=5。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'仕事の条件', q:'物理で仕事をしたといえるのは？', c:['力の向きに動かす','力を入れて止める','持ったまま静止','横に持って歩く'], a:0, desc:'力の向きに物体が動くと仕事をしたという。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'仕事の単位', q:'仕事の単位はどれ？', c:['W','Pa','N','J'], a:3, desc:'仕事の単位はJ(ジュール)。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'仕事率', q:'仕事率が表すものは？', c:['力の大きさ','時間あたりの仕事','物体の重さ','高さの差'], a:1, desc:'仕事率=仕事÷時間で表す。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'仕事率の単位', q:'仕事率の単位はどれ？', c:['J','N','m/s','W'], a:3, desc:'仕事率の単位はW(ワット)。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'仕事の原理', q:'道具を使っても変わらない量は？', c:['仕事の総量','必要な時間','動かす距離','力の大きさ'], a:0, desc:'摩擦を無視すると仕事の総量は変わらない。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'斜面の利点', q:'斜面で物体を上げる利点は？', c:['距離が短い','力を小さくできる','仕事が0になる','重力が消える'], a:1, desc:'小さい力で長い距離を動かす。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'位置エネルギー', q:'位置エネルギーが大きい条件は？', c:['低い位置','温度が低い','速さが小さい','高さが高い'], a:3, desc:'高い位置にあるほど位置エネルギーは大きい。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'運動エネルギー', q:'運動エネルギーが大きい条件は？', c:['高さが低い','時間が短い','色が濃い','速さが大きい'], a:3, desc:'同じ物体なら速いほど運動エネルギーは大きい。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'力学的エネルギー', q:'力学的エネルギーは何の和？', c:['熱と光','位置と運動','電気と熱','音と光'], a:1, desc:'位置エネルギーと運動エネルギーの和。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'エネルギー保存', q:'摩擦がないと力学的エネルギーは？', c:['増え続ける','0になる','一定に保たれる','熱だけになる'], a:2, desc:'摩擦などがなければ力学的エネルギーは保存される。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'下り坂の運動', q:'斜面を下る物体の速さは？', c:['一定','だんだん遅くなる','すぐ止まる','だんだん速くなる'], a:3, desc:'重力の一部が運動方向にはたらく。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'最高点', q:'振り子の最高点で最大なのは？', c:['運動エネルギー','位置エネルギー','仕事率','電気エネルギー'], a:1, desc:'最高点では高さが最大になる。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'最下点', q:'振り子の最下点で最大なのは？', c:['位置エネルギー','摩擦力','運動エネルギー','重さ'], a:2, desc:'最下点では速さが最大になる。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'水平移動の仕事', q:'重い荷物を水平に運ぶ重力の仕事は？', c:['最大','重さと同じ','距離と同じ','0'], a:3, desc:'重力の向きに移動していないため仕事は0。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'choice', name:'仕事率の比較', q:'同じ仕事を短時間ですると仕事率は？', c:['大きくなる','小さくなる','0になる','変わらない'], a:0, desc:'仕事率は仕事を時間で割る。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'12Nで5m動かす仕事(J)', formula:'60', plain:true, desc:'仕事=力×距離。12×5=60。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'8Nで7m動かす仕事(J)', formula:'56', plain:true, desc:'仕事=力×距離。8×7=56。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'25Nで4m動かす仕事(J)', formula:'100', plain:true, desc:'仕事=力×距離。25×4=100。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'18Nで3m動かす仕事(J)', formula:'54', plain:true, desc:'仕事=力×距離。18×3=54。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'30Nで6m動かす仕事(J)', formula:'180', plain:true, desc:'仕事=力×距離。30×6=180。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'14Nで8m動かす仕事(J)', formula:'112', plain:true, desc:'仕事=力×距離。14×8=112。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'45Nで2m動かす仕事(J)', formula:'90', plain:true, desc:'仕事=力×距離。45×2=90。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'16Nで9m動かす仕事(J)', formula:'144', plain:true, desc:'仕事=力×距離。16×9=144。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'80Jを10秒でする仕事率(W)', formula:'8', plain:true, desc:'仕事率=仕事÷時間。80÷10=8。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'150Jを15秒でする仕事率(W)', formula:'10', plain:true, desc:'仕事率=仕事÷時間。150÷15=10。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'240Jを20秒でする仕事率(W)', formula:'12', plain:true, desc:'仕事率=仕事÷時間。240÷20=12。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'360Jを30秒でする仕事率(W)', formula:'12', plain:true, desc:'仕事率=仕事÷時間。360÷30=12。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'96Jを12秒でする仕事率(W)', formula:'8', plain:true, desc:'仕事率=仕事÷時間。96÷12=8。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'200Jを25秒でする仕事率(W)', formula:'8', plain:true, desc:'仕事率=仕事÷時間。200÷25=8。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'75Jを5秒でする仕事率(W)', formula:'15', plain:true, desc:'仕事率=仕事÷時間。75÷5=15。' },
    { subject:'physics', genre:'motion', diff:'senior', type:'typing', name:'420Jを35秒でする仕事率(W)', formula:'12', plain:true, desc:'仕事率=仕事÷時間。420÷35=12。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'落下とエネルギー', q:'落下中に増えるエネルギーは？', c:['運動エネルギー','位置エネルギー','化学エネルギー','電気エネルギー'], a:0, desc:'速さが増して運動エネルギーが増える。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'落下と位置', q:'落下中に減るエネルギーは？', c:['運動エネルギー','熱エネルギー','位置エネルギー','光エネルギー'], a:2, desc:'高さが下がるので位置エネルギーが減る。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'保存の条件', q:'力学的エネルギー保存の条件は？', c:['摩擦を無視できる','時間が短い','物体が軽い','水平に動く'], a:0, desc:'摩擦や空気抵抗がなければ保存される。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'摩擦あり', q:'摩擦があると力学的エネルギーの一部は？', c:['電流になる','消えるだけ','重力になる','熱などになる'], a:3, desc:'力学的エネルギーは熱などへ移る。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'斜面の速さ', q:'同じ高さから下ると最下点の速さは？', c:['斜面が長いほど速い','高さが同じなら同じ','角度だけで決まる','質量で必ず決まる'], a:1, desc:'摩擦なしなら失った位置エネルギーで決まる。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'質量とエネルギー', q:'同じ速さなら質量が大きい物体の運動エネルギーは？', c:['小さい','0になる','大きい','同じ'], a:2, desc:'運動エネルギーは質量が大きいほど大きい。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'高さと質量', q:'位置エネルギーが大きい条件は？', c:['高さと重さが大きい','速さだけ大きい','時間が短い','摩擦が大きい'], a:0, desc:'位置エネルギーは重さと高さに比例する。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'仕事とエネルギー', q:'物体にした仕事は何の増加になる？', c:['温度だけ','エネルギー','質量','体積'], a:1, desc:'仕事をすると物体のエネルギーが変化する。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'投げ上げ上昇', q:'上へ投げた物体が上昇中、速さは？', c:['増える','一定','小さくなる','すぐ最大'], a:2, desc:'重力が運動と逆向きにはたらく。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'投げ上げ最高点', q:'投げ上げの最高点で速さは？', c:['最大','半分','一定','0'], a:3, desc:'一瞬止まってから落下に変わる。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'振り子の保存', q:'摩擦なしの振り子で保存される量は？', c:['速さ','位置エネルギーだけ','高さ','力学的エネルギー'], a:3, desc:'位置と運動の和が一定になる。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'仕事率大', q:'仕事率が大きい機械は？', c:['同じ時間で少ない仕事','同じ仕事を長時間','同じ仕事を短時間','仕事をしない'], a:2, desc:'短時間で多くの仕事をするほど仕事率は大きい。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'仕事ゼロ', q:'力を加えても仕事が0の例は？', c:['押して動かない','上へ持ち上げる','下へおろす','斜面を上げる'], a:0, desc:'移動距離が0なら仕事は0。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'斜面の仕事', q:'摩擦なしの斜面で必要な仕事は？', c:['必ず0','高さで決まる','斜面の長さだけ','速さで決まる'], a:1, desc:'持ち上げる仕事は重さ×高さで決まる。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'速さと運動E', q:'同じ物体で速さが大きいほど？', c:['運動エネルギーが大きい','位置が高い','質量が減る','仕事率が0'], a:0, desc:'運動エネルギーは速さが大きいほど大きい。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'台車と斜面', q:'斜面を下る台車の運動は？', c:['等速直線運動','だんだん速くなる','必ず止まる','逆向きに加速'], a:1, desc:'斜面下向きの力で速さが増す。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'平均の速さ総合', q:'平均の速さで使う距離は？', c:['最短距離だけ','最後の1秒だけ','全体の距離','最大の距離'], a:2, desc:'全体の距離を全体の時間で割る。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'エネルギー変換', q:'発電機では運動エネルギーが主に何へ変わる？', c:['電気エネルギー','位置エネルギー','質量','圧力'], a:0, desc:'発電機は運動を電気に変える装置。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'空気抵抗', q:'空気抵抗がある落下で失われる分は？', c:['位置エネルギーだけ増える','熱などへ移る','質量になる','重力が消える'], a:1, desc:'抵抗により力学的エネルギーの一部が熱などへ移る。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'choice', name:'エネルギーの合計', q:'位置100J、運動40Jの力学的エネルギーは？', c:['60J','100J','140J','400J'], a:2, desc:'力学的エネルギーは位置と運動の和。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'300mを60秒で進む速さ(m/s)', formula:'5', plain:true, desc:'速さ=距離÷時間。300÷60=5。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'540mを90秒で進む速さ(m/s)', formula:'6', plain:true, desc:'速さ=距離÷時間。540÷90=6。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'20Nで12m動かす仕事(J)', formula:'240', plain:true, desc:'仕事=力×距離。20×12=240。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'35Nで6m動かす仕事(J)', formula:'210', plain:true, desc:'仕事=力×距離。35×6=210。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'480Jを40秒でする仕事率(W)', formula:'12', plain:true, desc:'仕事率=仕事÷時間。480÷40=12。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'900Jを45秒でする仕事率(W)', formula:'20', plain:true, desc:'仕事率=仕事÷時間。900÷45=20。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'重さ30Nを5m上げる位置エネルギー(J)', formula:'150', plain:true, desc:'位置エネルギー=重さ×高さ。30×5=150。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'重さ45Nを4m上げる位置エネルギー(J)', formula:'180', plain:true, desc:'位置エネルギー=重さ×高さ。45×4=180。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'位置120J、運動80Jの合計(J)', formula:'200', plain:true, desc:'力学的エネルギー=位置+運動。120+80=200。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'位置250J、運動150Jの合計(J)', formula:'400', plain:true, desc:'力学的エネルギー=位置+運動。250+150=400。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'200J保存で位置70Jなら運動(J)', formula:'130', plain:true, desc:'運動エネルギー=合計-位置。200-70=130。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'360J保存で運動140Jなら位置(J)', formula:'220', plain:true, desc:'位置エネルギー=合計-運動。360-140=220。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'重さ60Nを3m上げる仕事(J)', formula:'180', plain:true, desc:'仕事=重さ×高さ。60×3=180。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'180Jを9秒でする仕事率(W)', formula:'20', plain:true, desc:'仕事率=仕事÷時間。180÷9=20。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'速さ8m/sで15秒進む距離(m)', formula:'120', plain:true, desc:'距離=速さ×時間。8×15=120。' },
    { subject:'physics', genre:'motion', diff:'supreme', type:'typing', name:'速さ12m/sで20秒進む距離(m)', formula:'240', plain:true, desc:'距離=速さ×時間。12×20=240。' },

    // ── 生物 応用/受験 バッチB-bio 2026-06-05 Codex生成→Claude QA(全53問の事実確認・肺動静脈/顕性潜性3:1/分離の法則等)→マージ。選択のみ。
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'昼の気体', q:'昼の葉で多く出る気体は?', c:['酸素','窒素','水素','アンモニア'], a:0, desc:'光があると光合成が呼吸を上回り、酸素が多く出ます。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'夜の植物', q:'夜の植物が行うのは?', c:['光合成のみ','呼吸のみ','蒸発のみ','受粉のみ'], a:1, desc:'光がない夜は光合成をせず、呼吸は続きます。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'気孔の役割', q:'気孔で主に調節するのは?', c:['花粉量','根の長さ','気体と水蒸気','種子の数'], a:2, desc:'気孔は二酸化炭素や酸素、水蒸気の出入りを調節します。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'気孔が閉じる時', q:'乾燥時に気孔は?', c:['増える','なくなる','葉脈になる','閉じやすい'], a:3, desc:'乾燥時は水分の失われすぎを防ぐため気孔が閉じやすくなります。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'師管の役割', q:'師管が運ぶものは?', c:['光合成の養分','水と無機養分','花粉','酸素だけ'], a:0, desc:'師管は葉でできた養分をからだの各部へ運びます。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'単子葉の茎', q:'単子葉類の維管束は?', c:['輪に並ぶ','散らばる','外にない','根だけにある'], a:1, desc:'単子葉類の茎では維管束が散らばって並ぶことが多いです。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'葉の表皮', q:'葉の表皮の主な役割は?', c:['受精する','種子を作る','内部を守る','根毛を作る'], a:2, desc:'表皮は葉の内部を守り、気孔で気体の出入りも行います。' },
    { subject:'biology', genre:'bio_plant', diff:'senior', type:'choice', name:'対照実験', q:'条件を1つだけ変える理由は?', c:['早く終えるため','色を濃くするため','水を増やすため','原因を確かめるため'], a:3, desc:'条件を1つだけ変えると、結果の原因を判断しやすくなります。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'脱色の理由', q:'葉をエタノールで脱色する理由は?', c:['色の変化を見やすくする','水を作る','気孔を増やす','根を伸ばす'], a:0, desc:'葉の緑色を抜くと、ヨウ素液の色の変化を見やすくできます。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'暗所処理', q:'光合成実験前に暗所へ置く目的は?', c:['葉を枯らす','デンプンをなくす','酸素を増やす','葉脈を消す'], a:1, desc:'暗所に置くと葉のデンプンが使われ、実験結果を比べやすくなります。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'石灰水実験', q:'呼吸で白くにごる液は?', c:['ヨウ素液','BTB液','石灰水','食塩水'], a:2, desc:'呼吸で出た二酸化炭素により、石灰水は白くにごります。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'明るい葉', q:'明るい葉の気体収支は?', c:['CO2だけ出る','O2だけ使う','気体は出ない','O2が多く出る'], a:3, desc:'明るい葉では光合成がさかんで、全体として酸素が多く出ます。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'蒸散量計算', q:'ワセリンなしで減った水は主に?', c:['蒸散した水','光合成でできた水','根で作った水','石灰水'], a:0, desc:'水面からの蒸発を防げば、減った水は主に葉からの蒸散量です。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'裏面ワセリン', q:'葉の裏にぬると蒸散は?', c:['増える','減る','変わらない','光合成になる'], a:1, desc:'気孔が多い裏面をふさぐと、水蒸気が出にくくなります。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'裸子植物総合', q:'裸子植物にないものは?', c:['胚珠','花粉','子房','種子'], a:2, desc:'裸子植物は胚珠がむき出しで、子房をもちません。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'双子葉の特徴', q:'双子葉類に多い組合せは?', c:['平行脈・ひげ根','胞子・仮根','子房なし・針葉','網状脈・主根'], a:3, desc:'双子葉類は網状脈で、主根と側根が見られることが多いです。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'分類の手順', q:'種子植物をまず分ける基準は?', c:['子房の有無','葉の色','根の太さ','花の数'], a:0, desc:'種子植物はまず被子植物と裸子植物に分けられます。' },
    { subject:'biology', genre:'bio_plant', diff:'supreme', type:'choice', name:'シダとコケ', q:'シダとコケの共通点は?', c:['果実を作る','胞子でふえる','子房がある','種子でふえる'], a:1, desc:'シダ植物とコケ植物は花や種子を作らず、胞子でふえます。' },
    { subject:'biology', genre:'bio_human', diff:'senior', type:'choice', name:'酵素の性質', q:'消化酵素の性質は?', c:['どれにも働く','熱で作られる','特定の物質に働く','血液だけにある'], a:2, desc:'消化酵素は決まった物質に対して働きます。' },
    { subject:'biology', genre:'bio_human', diff:'senior', type:'choice', name:'胆汁', q:'胆汁について正しいのは?', c:['デンプンを分解','酸素を運ぶ','尿を作る','脂肪を消化しやすくする'], a:3, desc:'胆汁は消化酵素ではありませんが、脂肪の消化を助けます。' },
    { subject:'biology', genre:'bio_human', diff:'senior', type:'choice', name:'肺動脈', q:'肺動脈を流れる血液は?', c:['酸素が少ない','酸素が多い','養分がない','血球がない'], a:0, desc:'肺動脈は心臓から肺へ向かう血管で、酸素の少ない血液が流れます。' },
    { subject:'biology', genre:'bio_human', diff:'senior', type:'choice', name:'肺胞の利点', q:'肺胞が多い利点は?', c:['血を作る','表面積が広い','骨を動かす','尿をためる'], a:1, desc:'肺胞が多数あることで表面積が広がり、気体交換が効率よくなります。' },
    { subject:'biology', genre:'bio_human', diff:'senior', type:'choice', name:'反射の中枢', q:'多くの反射の中枢は?', c:['小腸','肺','せきずい','肝臓'], a:2, desc:'熱い物から手を引く反射などは、主にせきずいを中枢として起こります。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'だ液対照', q:'だ液実験で水を入れる管の役割は?', c:['対照にする','温度を下げる','酸素を作る','糖を消す'], a:0, desc:'だ液ありと水だけを比べることで、だ液の働きを確かめます。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'だ液の温度', q:'だ液が働きやすい温度は?', c:['0度近く','体温に近い温度','100度','氷点下'], a:1, desc:'アミラーゼは体温に近い温度でよく働き、高温では働きにくくなります。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'肺静脈', q:'肺静脈を流れる血液は?', c:['酸素が少ない','尿素が多い','酸素が多い','血球がない'], a:2, desc:'肺で酸素を受け取った血液は、肺静脈を通って心臓へ戻ります。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'血液と肺', q:'肺で血液が受け取るものは?', c:['二酸化炭素','尿素','デンプン','酸素'], a:3, desc:'肺胞で血液は酸素を受け取り、二酸化炭素を出します。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'腎臓の排出', q:'腎臓で主に除くものは?', c:['尿素など','酸素','デンプン','花粉'], a:0, desc:'腎臓は血液中の尿素などの不要物をこし取り、尿を作ります。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'肝臓と尿素', q:'アンモニアを尿素に変える器官は?', c:['肺','肝臓','小腸','心臓'], a:1, desc:'肝臓は有害なアンモニアを尿素に変え、腎臓で排出されやすくします。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'反応時間', q:'刺激から反応までの時間は?', c:['蒸散量','消化時間','反応時間','肺活量'], a:2, desc:'刺激を受けてから運動が起こるまでの時間を反応時間といいます。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'反射の利点', q:'反射で脳を待たない利点は?', c:['記憶しやすい','血が増える','消化が速い','危険をすばやく避ける'], a:3, desc:'反射は判断を待たずに起こり、危険から体を守ります。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'恒常性', q:'体内の状態を保つ性質は?', c:['恒常性','光合成','受粉','蒸散'], a:0, desc:'体温や血糖濃度などを一定に保とうとする性質を恒常性といいます。' },
    { subject:'biology', genre:'bio_human', diff:'supreme', type:'choice', name:'血糖調節', q:'血糖値を下げるホルモンは?', c:['アミラーゼ','インスリン','ペプシン','胆汁'], a:1, desc:'インスリンは血液中の糖の濃度を下げる働きがあります。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'分裂の始め', q:'細胞分裂で最初に目立つのは?', c:['細胞壁','液胞','染色体','気孔'], a:2, desc:'分裂が始まると、核の中の染色体が観察しやすくなります。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'分裂の終わり', q:'体細胞分裂後にできる細胞の数は?', c:['1個','3個','4個','2個'], a:3, desc:'体細胞分裂では1個の細胞から2個の細胞ができます。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'減数分裂の数', q:'減数分裂で染色体数は?', c:['半分になる','変わらない','2倍になる','消える'], a:0, desc:'減数分裂では生殖細胞の染色体数が半分になります。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'受精後の数', q:'受精後の染色体数は?', c:['半分のまま','もとに戻る','4倍になる','なくなる'], a:1, desc:'半分の染色体をもつ生殖細胞が合体し、もとの数に戻ります。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'分離の法則', q:'生殖細胞へ遺伝子が分かれる法則は?', c:['慣性の法則','比例の法則','分離の法則','質量保存'], a:2, desc:'対になった遺伝子が生殖細胞に分かれて入ることを分離の法則といいます。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'メンデル材料', q:'メンデルが使った植物は?', c:['サクラ','マツ','タンポポ','エンドウ'], a:3, desc:'メンデルはエンドウを用いて遺伝の規則性を調べました。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'DNAの位置', q:'DNAは主にどこにある?', c:['染色体','気孔','柔毛','肺胞'], a:0, desc:'DNAは遺伝子の本体で、主に核内の染色体にあります。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'顕性と潜性', q:'子に現れやすい形質は?', c:['潜性形質','顕性形質','対立形質','無性形質'], a:1, desc:'対立形質のうち子に現れやすいものを顕性形質といいます。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'子の代の比', q:'1つの対立形質で子の代の顕性:潜性は多くの場合?', c:['1:1','1:2:1','3:1','2:3'], a:2, desc:'1つの対立形質では、子の代で顕性と潜性がおよそ3:1で現れます。' },
    { subject:'biology', genre:'bio_cell', diff:'supreme', type:'choice', name:'純系', q:'何代も同じ形質を出す系統は?', c:['雑種','個体群','分解者','純系'], a:3, desc:'同じ形質の子を代々生じる系統を純系といいます。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'矢印の向き', q:'食物連鎖の矢印は何の流れ?', c:['物質やエネルギー','風の向き','水蒸気だけ','血液'], a:0, desc:'食物連鎖の矢印は食べられるものから食べるものへ向けます。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'生産者の役割', q:'生産者が作るものは?', c:['無機物だけ','有機物','尿素','花粉だけ'], a:1, desc:'生産者は光合成などで無機物から有機物を作ります。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'分解者の役割', q:'分解者が戻すものは?', c:['酸素だけ','肉食動物','無機物','種子'], a:2, desc:'分解者は死がいやふんを分解し、無機物として環境へ戻します。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'炭素の入口', q:'炭素が植物へ入る形は?', c:['酸素','水素','窒素','二酸化炭素'], a:3, desc:'植物は光合成で大気中の二酸化炭素を取り入れます。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'酸素の発生', q:'酸素を多く出す働きは?', c:['光合成','呼吸','分解','排出'], a:0, desc:'光合成では二酸化炭素と水から有機物を作り、酸素を出します。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'呼吸の放出', q:'呼吸で多く出る気体は?', c:['酸素','二酸化炭素','窒素','水素'], a:1, desc:'呼吸では有機物を分解してエネルギーを取り出し、二酸化炭素を出します。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'外来種影響', q:'外来種で起こりやすいことは?', c:['必ず無害','必ず絶滅','在来種への影響','光合成停止'], a:2, desc:'外来種は在来種を食べたりすみかを奪ったりすることがあります。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'分類総合', q:'卵を水中に産み幼生はえら呼吸は?', c:['魚類','鳥類','ほ乳類','両生類'], a:3, desc:'両生類は多くが水中に卵を産み、幼生はえらで呼吸します。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'節足動物分類', q:'外骨格と節のあるあしをもつのは?', c:['節足動物','軟体動物','両生類','ほ乳類'], a:0, desc:'昆虫やエビなどは外骨格と節のあるあしをもつ節足動物です。' },
    { subject:'biology', genre:'bio_eco', diff:'supreme', type:'choice', name:'個体数変化', q:'肉食動物が増えると草食動物は?', c:['植物になる','へりやすい','必ず増える','変化しない'], a:1, desc:'肉食動物が増えると、食べられる草食動物は一時的にへりやすくなります。' },

    // ── 地学 応用/受験 バッチB-earth 2026-06-05 Codex生成→Claude QA(全43問の事実確認: P波S波/初期微動∝震源距離/湿度計算/海陸風/西高東低/満月の位置)→マージ。選択のみ。
    { subject:'earth', genre:'earth_land', diff:'senior', type:'choice', name:'安山岩', q:'安山岩はどれか。', c:['火山岩','深成岩','堆積岩','変成岩'], a:0, desc:'安山岩は地表付近で急に冷えた火山岩です。' },
    { subject:'earth', genre:'earth_land', diff:'senior', type:'choice', name:'閃緑岩', q:'閃緑岩はどれか。', c:['火山岩','深成岩','堆積岩','火山灰'], a:1, desc:'閃緑岩は地下深くでゆっくり冷えた深成岩です。' },
    { subject:'earth', genre:'earth_land', diff:'senior', type:'choice', name:'粘りと形', q:'粘りが大きい火山は。', c:['平らに広がる','低く広い','ドーム状','必ず噴火しない'], a:2, desc:'粘りが大きいマグマは流れにくく、盛り上がった火山になりやすいです。' },
    { subject:'earth', genre:'earth_land', diff:'senior', type:'choice', name:'初期微動', q:'初期微動が長い地点は。', c:['震央に近い','震源が浅いだけ','必ず震度が小さい','震源から遠い'], a:3, desc:'P波とS波の到着差は、震源から遠いほど大きくなります。' },
    { subject:'earth', genre:'earth_land', diff:'senior', type:'choice', name:'地層の新旧', q:'逆転なしの地層で古いのは。', c:['下の層','上の層','火山灰の上','粒が細い層'], a:0, desc:'地層はふつう下から上へ順に堆積します。' },
    { subject:'earth', genre:'earth_land', diff:'senior', type:'choice', name:'化石の区別', q:'年代を知る化石は。', c:['示相化石','示準化石','環境化石','鉱物化石'], a:1, desc:'示準化石は地層の年代を知る手がかりです。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'P波S波', q:'速い地震波はどれか。', c:['S波','表面波','P波','音波'], a:2, desc:'P波はS波より速く、先に到着します。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'距離と時間差', q:'震源距離が2倍なら初期微動は。', c:['同じ','半分','0になる','約2倍'], a:3, desc:'同じ地域では、初期微動継続時間は震源距離にほぼ比例します。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'震源距離', q:'初期微動10秒の地点は5秒の地点の。', c:['約2倍遠い','約半分近い','同じ距離','必ず震央'], a:0, desc:'初期微動継続時間が長いほど震源から遠いと考えられます。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'砂岩', q:'砂粒が固まった岩石は。', c:['れき岩','砂岩','泥岩','凝灰岩'], a:1, desc:'砂岩は砂ほどの粒が堆積して固まった岩石です。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'チャート', q:'うすい塩酸で泡が出にくいのは。', c:['石灰岩','大理石','チャート','貝殻'], a:2, desc:'チャートは主に二酸化ケイ素からなり、石灰岩のような発泡はしにくいです。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'かぎ層', q:'離れた地層を比べる目印は。', c:['海面','震央','風向','かぎ層'], a:3, desc:'広く分布する火山灰層などは、地層を比べるかぎ層になります。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'断層', q:'地層が切れてずれた構造は。', c:['断層','しゅう曲','整合','堆積'], a:0, desc:'断層は地層や岩盤が切れてずれた構造です。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'しゅう曲', q:'地層が曲がった構造は。', c:['断層','しゅう曲','震央','かぎ層'], a:1, desc:'しゅう曲は横からの力で地層が曲がった構造です。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'海溝型地震', q:'海溝付近の大地震の主因は。', c:['台風','雲の発生','プレート運動','月の満ち欠け'], a:2, desc:'海溝付近ではプレートの沈み込みが大地震の原因になります。' },
    { subject:'earth', genre:'earth_land', diff:'supreme', type:'choice', name:'火山帯', q:'火山が多い所は。', c:['砂浜だけ','川の下流','平野の中央だけ','プレート境界付近'], a:3, desc:'日本の火山や地震はプレート境界の運動と深く関係します。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'飽和量', q:'気温が高いほど飽和水蒸気量は。', c:['大きい','小さい','0になる','同じ'], a:0, desc:'空気が含める水蒸気量は、気温が高いほど大きくなります。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'湿度', q:'湿度は何の割合か。', c:['気圧の割合','実際の水蒸気量/飽和量','風速/気温','雲量/雨量'], a:1, desc:'湿度は実際の水蒸気量を飽和水蒸気量で割った割合です。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'露点到達', q:'空気が露点以下になると。', c:['必ず乾く','酸素になる','水滴ができる','気圧が0'], a:2, desc:'露点以下では水蒸気が凝結し、水滴や雲ができます。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'温暖前線後', q:'温暖前線通過後は。', c:['気温が下がる','雪だけ降る','風が止まる','気温が上がりやすい'], a:3, desc:'温暖前線の通過後は暖かい空気に入るため気温が上がりやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'雲の粒', q:'雲の主な粒は。', c:['水滴や氷','酸素の粒','食塩だけ','砂だけ'], a:0, desc:'雲は小さな水滴や氷の粒が集まったものです。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'風の向き', q:'風は主にどちらへ吹くか。', c:['低圧から高圧','高圧から低圧','北からだけ','南からだけ'], a:1, desc:'風は主に気圧の高い方から低い方へ向かって吹きます。' },
    { subject:'earth', genre:'earth_weather', diff:'senior', type:'choice', name:'等圧線間隔', q:'等圧線がせまい所は。', c:['風が弱い','雨がない','風が強い','必ず快晴'], a:2, desc:'等圧線の間隔がせまいほど気圧差が大きく、風が強くなりやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'湿度計算1', q:'水蒸気10g、飽和20gの湿度は。', c:['25%','50%','75%','100%'], a:1, desc:'湿度は10÷20×100で50%です。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'湿度計算2', q:'水蒸気12g、飽和16gの湿度は。', c:['75%','50%','25%','125%'], a:0, desc:'湿度は12÷16×100で75%です。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'露点判断', q:'水蒸気量が飽和量と同じ温度は。', c:['南中高度','前線面','露点','風向'], a:2, desc:'実際の水蒸気量が飽和水蒸気量に等しくなる温度が露点です。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'寒冷前線後', q:'寒冷前線通過後の変化は。', c:['気温上昇','南風だけ','湿度0%','気温低下'], a:3, desc:'寒冷前線の通過後は冷たい空気に入るため、気温が下がりやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'前線の雨', q:'寒冷前線の雨は。', c:['短時間で強い','広く弱く長い','雨がない','霧だけ'], a:0, desc:'寒冷前線では積乱雲が発達し、短時間に強い雨が降りやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'海風', q:'昼の海岸で吹きやすい風は。', c:['陸から海','海から陸','上から下','東からだけ'], a:1, desc:'昼は陸が暖まりやすく、海から陸へ海風が吹きやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'陸風', q:'夜の海岸で吹きやすい風は。', c:['海から陸','南から北','陸から海','下から上'], a:2, desc:'夜は陸が冷えやすく、陸から海へ陸風が吹きやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'梅雨の気団', q:'梅雨前線に関係が深い気団は。', c:['シベリアと赤道','揚子江とシベリア','小笠原だけ','小笠原とオホーツク海'], a:3, desc:'梅雨前線は小笠原気団とオホーツク海気団などの境にできます。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'冬型気圧配置', q:'冬型の気圧配置は。', c:['西高東低','東高西低','南高北低','北高南低'], a:0, desc:'冬は大陸側が高気圧、太平洋側が低気圧の西高東低になりやすいです。' },
    { subject:'earth', genre:'earth_weather', diff:'supreme', type:'choice', name:'台風', q:'台風は何が発達したものか。', c:['温帯低気圧','熱帯低気圧','高気圧','前線'], a:1, desc:'台風は熱帯の海上で発生した熱帯低気圧が発達したものです。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'自転方向', q:'地球の自転方向は。', c:['西から東','東から西','北から南','南から北'], a:0, desc:'地球は西から東へ自転するため、天体は東から西へ動いて見えます。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'年周運動', q:'星座が季節で変わる原因は。', c:['地球の自転','地球の公転','月の自転','太陽の黒点'], a:1, desc:'地球の公転により、同じ時刻に見える星座が季節で変わります。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'北の星', q:'北の空の星は何を中心に回るか。', c:['月','金星','北極星付近','太陽'], a:2, desc:'北の空の星は、北極星付近を中心に反時計回りに動いて見えます。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'南中高度', q:'北半球の夏、太陽の南中高度は。', c:['低い','変わらない','0度','高い'], a:3, desc:'北半球の夏は太陽の南中高度が高く、昼も長くなります。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'冬至', q:'冬至ごろの昼の長さは。', c:['短い','長い','24時間','必ず同じ'], a:0, desc:'北半球では冬至ごろに昼が最も短くなります。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'上弦の月', q:'夕方南に見える半月は。', c:['満月','上弦の月','新月','下弦の月'], a:1, desc:'上弦の月は夕方ごろ南の空に見え、右半分が明るく見えます。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'満月の位置', q:'満月のときの並びは。', c:['地球-太陽-月','月-太陽-地球','太陽-地球-月','太陽-月-地球'], a:2, desc:'満月は太陽、地球、月の順に並ぶ位置関係で見えます。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'金星の満ち欠け', q:'金星が満ち欠けする理由は。', c:['自ら光るから','地球の影だけ','黒点があるから','太陽光の反射面が変わる'], a:3, desc:'金星は太陽光を反射しており、位置関係で明るい面の見え方が変わります。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'内惑星', q:'内惑星の組はどれか。', c:['水星と金星','火星と木星','地球と月','土星と天王星'], a:0, desc:'地球より内側を公転する水星と金星を内惑星といいます。' },
    { subject:'earth', genre:'earth_space', diff:'supreme', type:'choice', name:'惑星順', q:'太陽に近い順で正しいのは。', c:['金星-水星-地球','水星-金星-地球','地球-金星-水星','水星-地球-金星'], a:1, desc:'太陽に近い順は、水星、金星、地球、火星です。' },
    // ───────── 小学校の復習(elementary)・化学 物質のすがた matter：もののとけ方/三態/空気と水/水溶液(小3〜小6) ─────────
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'形と重さ', q:'ねん土の形を変えると重さは？', c:['変わらない','重くなる','軽くなる','消える'], a:0, desc:'形を変えても、なくならないかぎり重さは同じです。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'分けた重さ', q:'ねん土を2つに分けると合計は？', c:['2倍になる','同じ重さ','半分になる','0になる'], a:1, desc:'分けても、全部を合わせた重さはもとの重さと同じです。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'ふくろの空気', q:'ふくらませた袋の空気には？', c:['重さがない','色がある','重さがある','形が同じ'], a:2, desc:'空気は見えませんが、ものなので少し重さがあります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'同じ体積', q:'同じ大きさで重さが違う理由は？', c:['色が違う','温度だけ','形だけ','ものが違う'], a:3, desc:'同じ大きさでも、材料が違うと重さは変わります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水の重さ', q:'水をこぼさず移すと重さは？', c:['変わらない','軽くなる','重くなる','なくなる'], a:0, desc:'入れ物を変えても、水の量が同じなら重さも同じです。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'空気を集める', q:'空気を集められるのはどれ？', c:['あみ','ふくろ','紙だけ','石'], a:1, desc:'空気は袋などに入れて集めることができます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'押された空気', q:'空気を押しちぢめると？', c:['固まる','消える','小さくなる','色が出る'], a:2, desc:'空気は押すと体積が小さくなり、もとに戻ろうとします。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'押された水', q:'水は押しちぢめられる？', c:['よく縮む','消える','空気になる','ほとんど縮まない'], a:3, desc:'水は空気とちがい、ほとんど押しちぢめられません。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水と空気', q:'注射器でよく縮むのは？', c:['空気','水','鉄','砂糖'], a:0, desc:'空気はよく縮みますが、水はほとんど縮みません。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水の形', q:'水は入れ物を変えると形は？', c:['いつも四角','入れ物の形','いつも丸','形なし'], a:1, desc:'水は決まった形がなく、入れ物に合わせて形が変わります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'こおりの形', q:'こおりの形は入れ物を出ると？', c:['すぐ消える','丸くなる','形が残る','液になる'], a:2, desc:'こおりは固体なので、取り出しても形が残ります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水の三つ', q:'水のすがたでないものは？', c:['水','こおり','水じょう気','砂'], a:3, desc:'水は水、こおり、水じょう気のすがたに変わります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'氷になる', q:'水を冷やしてできるものは？', c:['こおり','食塩','空気','砂'], a:0, desc:'水を十分に冷やすと、固体のこおりになります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水にもどる', q:'こおりを温めると何になる？', c:['砂','水','空気','食塩'], a:1, desc:'こおりを温めると、とけて液体の水になります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水じょう気', q:'水を熱すると出やすいものは？', c:['こおり','砂糖','水じょう気','鉄'], a:2, desc:'水を熱すると、目に見えない水じょう気になって出ていきます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'ゆげの正体', q:'白いゆげは何のつぶ？', c:['空気','けむり','食塩','小さな水'], a:3, desc:'白く見えるゆげは、水じょう気が冷えてできた小さな水です。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水のじゅんかん', q:'雨のもとになるのは？', c:['水じょう気','食塩','石','金属'], a:0, desc:'海や地面の水が水じょう気になり、冷えて雲や雨になります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'冷たいコップ', q:'冷たいコップの外の水は？', c:['中の水もれ','空気中の水','食塩水','油'], a:1, desc:'空気中の水じょう気が冷やされ、小さな水になってつきます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'ふっとう', q:'水がふっとうすると多く出るのは？', c:['砂','食塩','あわ','こおり'], a:2, desc:'ふっとうした水の中から、水じょう気のあわが出ます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'蒸発', q:'水たまりが小さくなる理由は？', c:['地面が食べる','砂になる','色が消える','水が空気へ'], a:3, desc:'水は少しずつ水じょう気になり、空気中へ出ていきます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'空気の中身', q:'空気について正しいのは？', c:['いろいろな気体','水だけ','酸素だけ','何もない'], a:0, desc:'空気は酸素やちっ素など、いろいろな気体が混ざったものです。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'ものが燃える', q:'ものが燃えるのに必要なのは？', c:['食塩','酸素','こおり','砂糖'], a:1, desc:'ろうそくなどが燃えるには、空気中の酸素が必要です。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'火をおおう', q:'火にびんをかぶせると消える理由は？', c:['水が増える','火が重い','酸素が減る','光が消える'], a:2, desc:'びんの中の酸素が少なくなると、燃え続けられません。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水中の空気', q:'魚が水中で使うものは？', c:['食塩','こおり','石','とけた空気'], a:3, desc:'水の中には空気が少しとけていて、魚はそれを使います。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'水にとける', q:'食塩を水に入れて混ぜると？', c:['見えにくくなる','必ずうく','石になる','火が出る'], a:0, desc:'食塩は水にとけると見えにくくなりますが、なくなってはいません。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'とけた食塩', q:'食塩水の食塩はどうなった？', c:['消えた','水にとけた','水になった','空気になった'], a:1, desc:'食塩は水の中に広がってとけています。消えたわけではありません。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'食塩水の重さ', q:'水100gに食塩10gをとかすと？', c:['約100g','約10g','約110g','0g'], a:2, desc:'とかしても食塩は残るので、全体の重さは水と食塩の合計です。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'取り出す', q:'食塩水から食塩を出すには？', c:['よく冷やす','紙であおぐ','色をつける','水を蒸発'], a:3, desc:'水を蒸発させると、とけていた食塩を取り出せます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'早くとかす', q:'砂糖を早くとかす方法は？', c:['よく混ぜる','暗くする','静かにする','ふたを取る'], a:0, desc:'よく混ぜると、水と砂糖がふれやすくなり早くとけます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'温度と溶け方', q:'砂糖がよくとける水は？', c:['冷たい水','温かい水','こおり水','油'], a:1, desc:'多くのものは、温かい水のほうがたくさんとけやすいです。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'とかす量', q:'食塩を入れすぎると？', c:['全部消える','水が固まる','底に残る','色が黒い'], a:2, desc:'水にとける量には限りがあり、こえると底に残ります。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'ろ過', q:'水に混じった砂を分けるには？', c:['熱するだけ','冷やすだけ','息をかける','ろ過する'], a:3, desc:'砂は水にとけにくいので、ろ紙などでこして分けられます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'食塩と砂', q:'水にとけるのはどちら？', c:['食塩','砂','どちらも不可','石'], a:0, desc:'食塩は水にとけますが、砂はほとんどとけません。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'酸性の水', q:'青リトマスを赤にするのは？', c:['中性','酸性','アルカリ性','水だけ'], a:1, desc:'酸性の水溶液は、青色リトマス紙を赤色に変えます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'アルカリ性', q:'赤リトマスを青にするのは？', c:['酸性','中性','アルカリ性','食塩'], a:2, desc:'アルカリ性の水溶液は、赤色リトマス紙を青色に変えます。' },
    { subject:'chemistry', genre:'matter', diff:'elementary', type:'choice', name:'食塩水', q:'食塩水の性質は？', c:['酸性','アルカリ性','気体','中性'], a:3, desc:'食塩水はふつう中性で、リトマス紙の色を変えません。' },
    // ───────── 小学校の復習(elementary)・物理 光・音 light_sound：光のまっすぐ/かげ/反射/虫めがね/太陽/音=ふるえ/伝わり(小3) ─────────
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'光の進み方', q:'光はふつうどう進む？', c:['まっすぐ','曲がる','止まる','丸く回る'], a:0, desc:'光はふつうまっすぐ進みます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'影の場所', q:'影は光が来る向きの？', c:['同じ側','反対側','真上','真下'], a:1, desc:'影は光がさえぎられた反対側にできます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'影のもと', q:'影ができるのはなぜ？', c:['物が光を通す','物が光を出す','物が光をさえぎる','物が音を出す'], a:2, desc:'物が光をさえぎると、その後ろに影ができます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'鏡の光', q:'鏡に当たった光は？', c:['消える','音になる','水になる','はね返る'], a:3, desc:'鏡に当たった光ははね返ります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'反射の名前', q:'光がはね返ることは？', c:['反射','発光','吸収','蒸発'], a:0, desc:'光がはね返ることを反射といいます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'明るさ', q:'光を集めると場所は？', c:['暗くなる','明るくなる','冷たくなる','見えない'], a:1, desc:'光を集めるとその場所は明るくなります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'日なた', q:'日なたは日かげより？', c:['暗い','冷たい','あたたかい','同じ色'], a:2, desc:'日なたは太陽の光で日かげよりあたたかいです。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'光と熱', q:'日なたが温かい理由は？', c:['音がある','影がある','風がない','光が当たる'], a:3, desc:'太陽の光が当たると物はあたたまります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'太陽の向き', q:'朝の太陽はどの方角？', c:['東','西','北','真下'], a:0, desc:'太陽は朝に東の方から見えます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'夕方の太陽', q:'夕方の太陽はどの方角？', c:['東','西','北','真上'], a:1, desc:'太陽は夕方に西の方に見えます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'影の動き', q:'太陽が動くとかげは？', c:['止まったまま','消える','動く','色が変わる'], a:2, desc:'太陽が動くと、かげの向きも少しずつ動きます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'昼の影', q:'昼ごろの影はどうなる？', c:['長め','消える','丸い','短め'], a:3, desc:'太陽が高い昼ごろは影が短めになります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'朝夕の影', q:'朝や夕方の影は？', c:['長い','短い','ない','明るい'], a:0, desc:'太陽が低い朝や夕方は影が長くなります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'光と目', q:'物が見えるのはなぜ？', c:['音が目に届く','光が目に届く','物が自分で光る','目から光が出る'], a:1, desc:'物にはね返った光が目に届くと、物が見えます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'透明な物', q:'ガラスは光を？', c:['止める','音にする','通しやすい','曲げない'], a:2, desc:'ガラスは光を通しやすい物です。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'光を通さない物', q:'光をほとんど通さない物は？', c:['とうめいなガラス','水','空気','木の板'], a:3, desc:'木の板のような不とうめいな物は、光をほとんど通しません。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'虫めがね', q:'虫めがねで集めるのは？', c:['光','音','風','におい'], a:0, desc:'虫めがねは光を集めることができます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'鏡の重ね光', q:'鏡の光を重ねると？', c:['より暗い','より明るい','音になる','影が消える'], a:1, desc:'鏡ではね返した光を重ねると明るくなります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'音のもと', q:'音が出る時、物は？', c:['止まる','溶ける','ふるえる','光る'], a:2, desc:'音が出るとき物はふるえています。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'音を止める', q:'ふるえを止めると音は？', c:['大きくなる','高くなる','光になる','止まる'], a:3, desc:'物のふるえを止めると音も止まります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'大きい音', q:'大きい音の時のふるえは？', c:['大きい','小さい','ない','遅いだけ'], a:0, desc:'大きい音は物のふるえが大きいときに出ます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'ふるえと手', q:'音が出ている物にふれると？', c:['冷たくなる','手にふるえを感じる','光る','重くなる'], a:1, desc:'音を出している物はふるえているので、ふれるとふるえが伝わります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'音の伝わり', q:'音は何を伝わる？', c:['影','光','空気','電池'], a:2, desc:'音は空気などを伝わって耳に届きます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'耳をふさぐ', q:'耳をふさぐと音は？', c:['大きくなる','高くなる','光になる','聞こえにくい'], a:3, desc:'音は耳に届いて聞こえるので、ふさぐと聞こえにくくなります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'糸電話', q:'糸電話で音を伝える物は？', c:['糸','空気だけ','水','磁石'], a:0, desc:'糸電話では、ぴんと張った糸のふるえが音を伝えます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'糸電話の糸', q:'糸電話の糸はどうする？', c:['ゆるくする','ぴんと張る','切る','ぬらす'], a:1, desc:'糸電話は糸をぴんと張ると伝わりやすいです。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'太鼓の音', q:'太鼓は何がふるえる？', c:['水','影','皮','光'], a:2, desc:'太鼓は張った皮がふるえて音を出します。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'輪ゴムの音', q:'輪ゴムをはじくと？', c:['固まる','暗くなる','消える','ふるえる'], a:3, desc:'輪ゴムをはじくとふるえて音が出ます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'声の正体', q:'声は体の中の何で出る？', c:['のどのふるえ','目の光','手の熱','足の力'], a:0, desc:'声はのどの中がふるえて出ます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'音と水', q:'音は水の中を？', c:['伝わらない','伝わる','光になる','影になる'], a:1, desc:'音は空気だけでなく水の中も伝わります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'音と物', q:'音は物の中を？', c:['必ず止まる','消える','伝わる','光る'], a:2, desc:'音は木や金属などの物の中も伝わります。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'色とあたたかさ', q:'日光であたたまりやすい色は？', c:['白い色','とうめい','銀色','黒い色'], a:3, desc:'黒い色は日光をよく吸収するので、あたたまりやすいです。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'雷の理由', q:'雷で光が音より先なのは？', c:['光が速い','音が速い','影が速い','風が速い'], a:0, desc:'光は音よりずっと速く進むので、いなずまが先に見えます。' },
    { subject:'physics', genre:'light_sound', diff:'elementary', type:'choice', name:'見える理由', q:'暗い所で物が見えにくいのは？', c:['音が少ない','光が少ない','空気がない','水が多い'], a:1, desc:'暗い所では目に届く光が少ないので見えにくいです。' },
    // ───────── 小学校の復習(elementary)・生物 植物 bio_plant：体のつくり/発芽3条件/成長と日光肥料/花と受粉/でんぷん/呼吸(小3〜小6) ─────────
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'種まき', q:'種をまくと先に出やすいのは？', c:['根','花','実','葉'], a:0, desc:'種からはまず根が出て、水を吸いやすくします。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'芽ばえ', q:'種から出た小さな植物を何という？', c:['花粉','芽ばえ','実','球根'], a:1, desc:'種から出たばかりの小さな植物を芽ばえといいます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'子葉', q:'芽ばえで最初に開く葉は？', c:['花びら','根','子葉','実'], a:2, desc:'多くの芽ばえでは最初に子葉が開いて育ち始めます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'根のはたらき', q:'根の主なはたらきはどれ？', c:['花を作る','実を作る','光を出す','水を吸う'], a:3, desc:'根は土の中から水を吸い上げる大切な部分です。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'くきのはたらき', q:'くきは何を上へ運ぶ？', c:['水','花粉','種','土'], a:0, desc:'くきは根から吸った水を葉や花へ運びます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'葉のはたらき', q:'葉に日光が当たると作られるものは？', c:['花粉','でんぷん','土','根'], a:1, desc:'葉は日光を受けるとでんぷんなどの養分を作ります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'日光と成長', q:'植物がよく育つのに大切なのは？', c:['石','音','日光','暗やみ'], a:2, desc:'植物の成長には水だけでなく日光も大切です。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'水やり', q:'植物に水をやる主な理由は？', c:['花の色を変えるため','虫をよせるため','土を冷やすため','育つため'], a:3, desc:'植物は水を吸って体を保ち、育つために使います。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'空気と発芽', q:'種の発芽に必要なものは？', c:['空気','肥料','日光','花びら'], a:0, desc:'発芽には水・空気・適当な温度が必要です。日光や肥料は発芽には要りません。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'発芽の水', q:'種が発芽するのに必要なものは？', c:['日光','水','肥料','花粉'], a:1, desc:'種は水を吸うことで発芽の準備を始めます。日光や肥料は発芽には要りません。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'発芽の温度', q:'種が発芽しやすい温度は？', c:['いつも氷点下','とても熱い','適当な温度','温度は無関係'], a:2, desc:'種の発芽には植物に合った適当な温度が必要です。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'肥料', q:'植物を大きく育てる助けになるものは？', c:['砂だけ','ガラス','紙','肥料'], a:3, desc:'肥料は植物が育つための養分を補うはたらきがあります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'春の芽', q:'春によく見られる植物の変化は？', c:['芽が出る','葉が全部落ちる','種が凍る','花が消える'], a:0, desc:'春は暖かくなり、多くの植物が芽を出し始めます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'夏の植物', q:'夏に植物がよく育つ理由は？', c:['雪が多い','日光が多い','水がない','夜だけ育つ'], a:1, desc:'夏は日光が強く気温も高いため植物が育ちやすいです。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'秋の実', q:'秋に多く見られる植物の変化は？', c:['花がふえる','葉が緑こくなる','実や種ができる','背がぐんと伸びる'], a:2, desc:'秋には実や種ができ、次の世代につながります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'冬ごし', q:'ヘチマなどは冬を何でこす？', c:['花','青い葉','水だけ','種'], a:3, desc:'ヘチマなどは種を残して冬をこし、次の春に育ちます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'サクラの春', q:'サクラが春に多くつけるものは？', c:['花','実','根','球根'], a:0, desc:'サクラは春に花を咲かせる代表的な植物です。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'ヘチマのつる', q:'ヘチマが伸ばしていくものは？', c:['石','つる','羽','角'], a:1, desc:'ヘチマはつるを伸ばしながら大きく育ちます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'花の役目', q:'花のあとにできることが多いものは？', c:['根','土','実','水'], a:2, desc:'花のあとには実ができ、その中に種が入ることがあります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'花粉', q:'おしべの先にある粉は？', c:['でんぷん','土','水','花粉'], a:3, desc:'おしべの先には花粉があり、実や種づくりに関係します。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'おしべ', q:'花粉を作る花の部分は？', c:['おしべ','めしべ','根','葉'], a:0, desc:'おしべは花粉を作る花の部分です。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'めしべ', q:'花粉がつく花の部分は？', c:['葉','めしべ','根','くき'], a:1, desc:'花粉はめしべの先につくことで実や種づくりにつながります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'受粉', q:'花粉がめしべの先につくことは？', c:['発芽','蒸発','受粉','反射'], a:2, desc:'花粉がめしべの先につくことを受粉といいます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'受粉のあと', q:'受粉のあとにできやすいものは？', c:['石','音','光','実'], a:3, desc:'受粉すると花の一部が育って実になることがあります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'実の中', q:'実の中に入っていることが多いものは？', c:['種','花びら','水だけ','根'], a:0, desc:'実の中には次の植物になる種が入っていることが多いです。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'アサガオの実', q:'アサガオの実の中にあるものは？', c:['花粉','種','葉','くき'], a:1, desc:'アサガオの実の中には黒っぽい種ができます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'花びら', q:'花で色が目立つことが多い部分は？', c:['根','くき','花びら','種'], a:2, desc:'花びらは色や形で目立ち、虫をよせることがあります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'がく', q:'つぼみを外から守ることが多い部分は？', c:['根','実','葉脈','がく'], a:3, desc:'がくは花の外側にあり、つぼみを守ることがあります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'葉脈', q:'葉に見えるすじを何という？', c:['葉脈','子葉','花びら','がく'], a:0, desc:'葉に見えるすじを葉脈といい、水などの通り道になります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'葉の表面', q:'葉に日光が当たりやすい形は？', c:['細長いトゲ','平たく広い','まるい玉','かたいから'], a:1, desc:'葉は平たく広がることで日光を受けやすくなります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'水の通り道', q:'根から葉へ水を運ぶ主な通り道は？', c:['花びら','種','くき','実'], a:2, desc:'根から吸った水はくきを通って葉へ運ばれます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'根の広がり', q:'根が土の中で広がる理由は？', c:['花を光らせるため','種を飛ばすため','音を出すため','水を吸うため'], a:3, desc:'根は土の中に広がり、水を吸いやすくしています。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'ホウセンカ', q:'ホウセンカの体にある部分は？', c:['根・くき・葉','羽・足・目','石・砂・水','火・音・光'], a:0, desc:'ホウセンカなどの植物の体には根、くき、葉があります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'葉から出る水', q:'葉から空気中に出ていくものは？', c:['花粉','水(水じょう気)','でんぷん','土'], a:1, desc:'根から吸った水の一部は、葉から水じょう気となって出ていきます。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'でんぷん調べ', q:'でんぷんを調べる液は？', c:['石けん水','食塩水','ヨウ素液','水道水'], a:2, desc:'ヨウ素液はでんぷんがあると青むらさき色になります。' },
    { subject:'biology', genre:'bio_plant', diff:'elementary', type:'choice', name:'植物の呼吸', q:'植物もしていることは？', c:['会話','歩く','発電','呼吸'], a:3, desc:'植物も生き物なので、人や動物と同じように呼吸をしています。' },
    // ───────── 小学校の復習(elementary)・地学 大地 earth_land：流れる水のはたらき/上流下流/地層/化石/火山/地震(小4〜小6) ─────────
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'水の流れ', q:'雨水は地面の上をどちらへ流れやすい？', c:['高い所から低い所','低い所から高い所','同じ所を回る','空へ上がる'], a:0, desc:'水は高い所から低い所へ流れる性質があります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'流れの速さ', q:'水の流れが速いのはどんな場所？', c:['かたむきがない','かたむきが急','平らな池','広い海'], a:1, desc:'地面のかたむきが急なほど水は速く流れます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'土のけずれ', q:'流れる水が地面をけずるはたらきは？', c:['日光','風向き','しん食','発芽'], a:2, desc:'流れる水が地面をけずるはたらきをしん食といいます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'運ぶはたらき', q:'流れる水が土や石を運ぶはたらきは？', c:['発光','蒸発','消化','運ぱん'], a:3, desc:'流れる水はけずった土や石を下流へ運びます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'積もるはたらき', q:'流れがゆるくなると土や砂はどうなる？', c:['積もる','燃える','とける','空へ飛ぶ'], a:0, desc:'流れがゆるい場所では運ばれた土や砂が積もります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'つぶの大きさ', q:'水の流れで動きやすいのはどれ？', c:['大きな岩','小さい砂','人の頭ほどの石','こぶし大の石'], a:1, desc:'小さいつぶは大きな石より流れる水で動きやすいです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'雨の日の川', q:'大雨のあと川の水はふつうどうなる？', c:['なくなる','こおる','増える','海へ戻る'], a:2, desc:'大雨のあとは水が集まり川の水の量が増えます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'水量と力', q:'川の水の量が増えるとけずる力は？', c:['弱くなる','変わらない','なくなる','強くなる'], a:3, desc:'水の量が増えると流れの力が強くなります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'にごる川', q:'大雨のあと川がにごる主な理由は？', c:['土砂を運ぶ','水が光る','魚が増える','空気が出る'], a:0, desc:'川がにごるのは水が土や砂を多く運ぶからです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'川の上流', q:'川の上流に多い石の形はどれ？', c:['丸い砂だけ','角ばった石','やわらかい土','貝がらだけ'], a:1, desc:'上流では石があまりけずられず角ばったものが多いです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'川の下流', q:'川の下流に多い石の形はどれ？', c:['角ばった岩','こおり','丸い石','火山灰だけ'], a:2, desc:'下流へ運ばれる間に石はぶつかって丸くなります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'川の曲がり', q:'川が曲がる所で外側の流れは？', c:['止まりやすい','逆に流れる','なくなる','速くなりやすい'], a:3, desc:'川の曲がりの外側は流れが速くけずられやすいです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'内側の流れ', q:'川が曲がる所で内側には何が起こりやすい？', c:['砂が積もる','岩が燃える','水が消える','雪が降る'], a:0, desc:'曲がりの内側は流れがゆるく砂が積もりやすいです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'河原の石', q:'河原に丸い石が多い理由は？', c:['日光でとけた','水でけずれる','もともと丸かった','こおりがついた'], a:1, desc:'石は流される間にぶつかり合って角がとれます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'山の近く', q:'山の近くの川で流れが速い理由は？', c:['海が近いから','川はばが広いから','坂が急だから','風がないから'], a:2, desc:'山の近くは地面のかたむきが急なので流れが速いです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'海の近く', q:'海の近くの川で流れがゆるい理由は？', c:['山が高い','雨がない','石がない','平らに近い'], a:3, desc:'海の近くは土地が平らに近く流れがゆるくなります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'たい積の場所', q:'川が海や湖に入る所で起こりやすいのは？', c:['土砂が積もる','岩がとける','水が燃える','風が止まる'], a:0, desc:'流れがゆるくなる場所では土や砂が積もりやすいです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'小石と砂', q:'流れが弱い時に先に積もりやすいのは？', c:['小さなつぶ','大きなつぶ','水だけ','空気だけ'], a:1, desc:'大きく重いつぶほど流れが弱いと先に積もります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'水害の注意', q:'大雨の時に川へ近づくのはなぜ危ない？', c:['水がきれいになる','流れがおそくなる','急に増水する','川底が見える'], a:2, desc:'大雨では川の水が急に増えて流れも強くなります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'水の通り道', q:'雨水がよく集まって流れる場所は？', c:['高い屋根の上','山の頂上','かわいた砂地','低いくぼみやみぞ'], a:3, desc:'雨水は低いくぼみやみぞに集まって流れます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'しまもよう', q:'がけに見えるしまもようは何の重なり？', c:['土や砂の層','雲のかげ','木の根','川の水'], a:0, desc:'がけのしまもようは土や砂などの層が重なったものです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'地層の材料', q:'地層を作るものとして合うのはどれ？', c:['火と水じょう気','れきや砂やどろ','鉄とガラス','紙と布'], a:1, desc:'地層はれきや砂やどろなどが積もってできます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'層の重なり', q:'地層はふつうどのように見える？', c:['一色に光る','丸く回る','層が重なる','空に浮く'], a:2, desc:'地層はちがうつぶの層が重なって見えることがあります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'下の層', q:'積もってできた地層で古いことが多いのは？', c:['上の層','横の空気','表面の草','下の層'], a:3, desc:'ふつうは先に積もった下の層ほど古いことが多いです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'上の層', q:'積もってできた地層で新しいことが多いのは？', c:['上の層','下の層','中の石だけ','水の中'], a:0, desc:'あとから積もった上の層ほど新しいことが多いです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'丸いれき', q:'丸いれきが多い層は何で運ばれたと考えやすい？', c:['強い光','流れる水','植物の根','動物の声'], a:1, desc:'丸いれきは水で運ばれる間に角がとれたと考えられます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'砂の層', q:'砂がたくさん積もったところにできる層は？', c:['氷の層','火の層','砂の層','空気の層'], a:2, desc:'同じような砂が多く積もると砂の層ができます。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'どろの層', q:'細かなどろが静かに積もるとできやすい層は？', c:['大岩の層','木の層','光の層','どろの層'], a:3, desc:'細かいつぶは流れがとてもゆるい場所で積もりやすいです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'化石', q:'地層から見つかる昔の生き物のあとを何という？', c:['化石','電池','星座','気体'], a:0, desc:'化石は昔の生き物のからだや生活のあとが残ったものです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'貝の化石', q:'貝の化石がある地層から考えやすいことは？', c:['昔は空の上','昔は水の中','今も燃える','石ではない'], a:1, desc:'貝の化石はその場所が昔は海や水辺だった手がかりです。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'地層の観察', q:'がけの地層を見る時に大切なことは？', c:['下を掘り続ける','石を投げる','安全に見る','走って近づく'], a:2, desc:'がけはくずれることがあるので安全な場所から観察します。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'土地の変化', q:'流れる水で土地は長い時間をかけてどうなる？', c:['必ず高くなる','動かなくなる','透明になる','形が変わる'], a:3, desc:'水のしん食やたい積で土地の形は少しずつ変わります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'火山灰', q:'火山がふん火した時に積もることがあるものは？', c:['火山灰','食塩','こおり','わた'], a:0, desc:'火山がふん火すると細かい火山灰が広い場所に積もります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'地面のゆれ', q:'地震が起きると地面はどうなる？', c:['必ず光る','ゆれる','必ず雨が降る','水になる'], a:1, desc:'地震では地面がゆれて建物や土地に変化が出ることがあります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'地震と土地', q:'大きな地震のあと地面に起こることは？', c:['必ず平らになる','必ず低くなる','ずれや段差ができる','色が変わる'], a:2, desc:'大きな地震では、地面にずれや段差ができることがあります。' },
    { subject:'earth', genre:'earth_land', diff:'elementary', type:'choice', name:'土地の高さ', q:'土地は長い年月でどうなることがある？', c:['ぜったい変わらない','すぐ消える','空にうかぶ','高くなることがある'], a:3, desc:'土地は長い年月をかけて、高くなったり低くなったりすることがあります。' },
    ];
